...
subcategory: "Kibana"
description: |-
  Enables Elastic Security detection rules based on tags. This resource uses the Kibana bulk action API to enable all rules matching the specified tag key-value pair. See https://www.elastic.co/guide/en/security/current/rules-ui-management.html
---
