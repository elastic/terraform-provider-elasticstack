...
subcategory: "Fleet"
description: |-
  Manages Fleet cloud connectors. See the Fleet Cloud Connectors API documentation https://www.elastic.co/docs/api/doc/kibana/group/endpoint-fleet-cloud-connectors for more information.
---
