...
To gather info about Features, see: https://www.elastic.co/guide/en/kibana/current/features-api-get.html

To gather info about Security Privileges, see: https://www.elastic.co/guide/en/elasticsearch/reference/current/security-privileges.html
