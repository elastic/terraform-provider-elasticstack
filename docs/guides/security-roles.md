...
| `dashboard` | `all`, `read`, `minimal_all`, `minimal_read`, `url_create`, `createNew` |
| `visualize` | `all`, `read`, `minimal_all`, `minimal_read`, `url_create`, `saveQuery` |
| `ml` | `all`, `read` |
| `apm` | `all`, `read` |
| `fleet` | `all`, `read` |
| `siem` | `all`, `read`, `minimal_all`, `minimal_read`, `cases_all`, `cases_read`, `cases_delete` |
| `securitySolutionCases` | `all`, `read`, `minimal_all`, `minimal_read`, `cases_all`, `cases_read`, `cases_delete` |
| `observabilityCases` | `all`, `read`, `minimal_all`, `minimal_read`, `cases_all`, `cases_read`, `cases_delete` |
| `osquery` | `all`, `read`, `minimal_all`, `minimal_read`, `live_queries_all`, `live_queries_read`, `run_saved_queries`, `saved_queries_all`, `saved_queries_read`, `packs_all`, `packs_read` |
| `rulesSettings` | `all`, `read`, `minimal_all`, `minimal_read`, `readFlappingSettings` |
| `actions` | `all`, `read` |
| `alerting` | `all`, `read` |
| `canvas` | `all`, `read` |
| `maps` | `all`, `read` |
