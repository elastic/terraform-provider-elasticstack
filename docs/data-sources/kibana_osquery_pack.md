...
subcategory: "Kibana"
description: |-
  Reads an Osquery query pack from Kibana by pack_id (saved_object_id). Use this data source to reference prebuilt (read-only) packs that cannot be managed by the elasticstack_kibana_osquery_pack resource. Requires Kibana 8.5.0 or later.
---
