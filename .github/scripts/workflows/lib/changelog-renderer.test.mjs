...
// Assign `pr-changelog-parser` exports to `global` before requiring the renderer so
// renderer internals that expect parser helpers on `global` behave as in production
// `actions/github-script` runs when both modules are loaded in one process.
