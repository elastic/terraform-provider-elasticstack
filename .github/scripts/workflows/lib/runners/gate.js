...
const GATES = {
  provider: {
    ...
    fields: ['CLASSIFY_RESULT', 'BUILD_RESULT', 'LINT_RESULT', 'GOLANGCI_LINT_RESULT', 'LOAD_MATRIX_RESULT', 'TEST_RESULT', 'UNIT_TEST_RESULT'],
    evaluate: (env) => gateProvider({
      ...
      loadMatrixResult: env.LOAD_MATRIX_RESULT,
