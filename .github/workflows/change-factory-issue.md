  ...
  steps:
    ...
    - name: Capture command text
      ...
      with:
        github-token: ${{ secrets.GITHUB_TOKEN }}
        script: |
          const fn = require('${{ github.workspace }}/.github/scripts/workflows/change-factory/capture-command-text.js');
          await fn({ github, context, core });
    ...
    - name: Fetch issue comments
      ...
      with:
        github-token: ${{ secrets.GITHUB_TOKEN }}
        script: |
          const fn = require('${{ github.workspace }}/.github/scripts/workflows/change-factory/fetch-issue-comments.js');
          await fn({ github, context, core });
    - name: Extract research comment
      ...
      with:
        github-token: ${{ secrets.GITHUB_TOKEN }}
        script: |
          const fn = require('${{ github.workspace }}/.github/scripts/workflows/change-factory/extract-research-comment.js');
          await fn({ github, context, core });
    ...
    - name: Notify duplicate blocked
      ...
      with:
        github-token: ${{ secrets.GITHUB_TOKEN }}
        script: |
          const fn = require('${{ github.workspace }}/.github/scripts/workflows/change-factory/notify-duplicate-blocked.js');
          await fn({ github, context, core });
