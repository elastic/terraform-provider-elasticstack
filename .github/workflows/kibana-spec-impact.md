...
5. After successfully creating issues for **all** high-confidence entities you processed this run, update repo memory by running:
   ```
   ...
   ```
   Use the repo-memory path configured for this workflow if it differs in your environment.
