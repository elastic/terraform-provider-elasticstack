...
- Amend all Fleet and utils/tfsdk instances of diagnostics parameters to pass by pointer instead of pass by value. ([#855](https://github.com/elastic/terraform-provider-elasticstack/pull/855))
