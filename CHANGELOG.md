...
- New resource `elasticstack_elasticsearch_security_role_mapping` to manage Elasticsearch [role mappings](https://www.elastic.co/guide/en/elasticsearch/reference/current/security-api-put-role-mapping.html) ([#69](https://github.com/elastic/terraform-provider-elasticstack/pull/69))
