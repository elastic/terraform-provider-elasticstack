...
- migrate elasticstack_kibana_synthetics_monitor to generated kbapi client ([#2301](https://github.com/elastic/terraform-provider-elasticstack/pull/2301))
- feat(kibana-security-role): migrate elasticstack_kibana_security_role to kbapi ([#2300](https://github.com/elastic/terraform-provider-elasticstack/pull/2300))
- feat: migrate synthetics private location to generated kbapi client ([#2299](https://github.com/elastic/terraform-provider-elasticstack/pull/2299))
- feat: migrate kibana space/spaces to generated kbapi client ([#2298](https://github.com/elastic/terraform-provider-elasticstack/pull/2298))
- feat: migrate kibana_import_saved_objects to kbapi client ([#2289](https://github.com/elastic/terraform-provider-elasticstack/pull/2289))
- Preserve redacted watch actions on refresh ([#2296](https://github.com/elastic/terraform-provider-elasticstack/pull/2296))
- feat(watcher): migrate elasticstack_elasticsearch_watch to Plugin Framework ([#2287](https://github.com/elastic/terraform-provider-elasticstack/pull/2287))
- feat: typed Elasticsearch client resolution via ProviderClientFactory ([#2284](https://github.com/elastic/terraform-provider-elasticstack/pull/2284))
- feat: typed Kibana/Fleet client resolution via ProviderClientFactory ([#2279](https://github.com/elastic/terraform-provider-elasticstack/pull/2279))
- feat: roll out kibana_connection to all registered Kibana and Fleet entities ([#2262](https://github.com/elastic/terraform-provider-elasticstack/pull/2262))
- feat: add synthetics_stats_overview panel support to elasticstack_kibana_dashboard ([#2165](https://github.com/elastic/terraform-provider-elasticstack/pull/2165))
- Add Agent Builder tool resource and data source ([#2111](https://github.com/elastic/terraform-provider-elasticstack/pull/2111))
- [Feature] Add remote_elasticsearch output support for fleet ([#2131](https://github.com/elastic/terraform-provider-elasticstack/pull/2131))
- feat(kibana-dashboard): add structured pie chart legend ([#2178](https://github.com/elastic/terraform-provider-elasticstack/pull/2178))
- fix(security_role): preserve id in plan via UseStateForUnknown ([#2160](https://github.com/elastic/terraform-provider-elasticstack/pull/2160))
- Import computed fields for `semantic_text` types for the `elasticstack_elasticsearch_index` resource ([#2112](https://github.com/elastic/terraform-provider-elasticstack/pull/2112))
- Add synthetics_monitors panel support to elasticstack_kibana_dashboard ([#2164](https://github.com/elastic/terraform-provider-elasticstack/pull/2164))
- ILM: require searchable_snapshot in frozen phase ([#2168](https://github.com/elastic/terraform-provider-elasticstack/pull/2168))
...
- Add Inference endpoint resource ([#1955](https://github.com/elastic/terraform-provider-elasticstack/pull/1955))
- Update dataview without recreate via space API ([#2129](https://github.com/elastic/terraform-provider-elasticstack/pull/2129))
- feat(kibana): add space_id to synthetics private location resource ([#2142](https://github.com/elastic/terraform-provider-elasticstack/pull/2142))
- Fix Fleet resources to use space-scoped API endpoints for space-restricted API keys (#1947) ([#2084](https://github.com/elastic/terraform-provider-elasticstack/pull/2084))
- Align Kibana dashboard schema with the Dashboard API ([#2146](https://github.com/elastic/terraform-provider-elasticstack/pull/2146))
- Align dashboard resource with regenerated Kibana API ([#2138](https://github.com/elastic/terraform-provider-elasticstack/pull/2138))
- feat: add options_list_control_config panel type to kibana_dashboard resource ([#2076](https://github.com/elastic/terraform-provider-elasticstack/pull/2076))
- feat: add SLO Overview panel type to kibana_dashboard resource ([#2097](https://github.com/elastic/terraform-provider-elasticstack/pull/2097))
- feat: add range_slider_control_config panel type to kibana_dashboard resource ([#2077](https://github.com/elastic/terraform-provider-elasticstack/pull/2077))
- Migrate ILM resource to the plugin framework ([#2002](https://github.com/elastic/terraform-provider-elasticstack/pull/2002))
- feat(kibana_dashboard): add slo_error_budget panel type ([#2098](https://github.com/elastic/terraform-provider-elasticstack/pull/2098))
- Add inference ingest processor ([#1956](https://github.com/elastic/terraform-provider-elasticstack/pull/1956))
- Add Streams support ([#2027](https://github.com/elastic/terraform-provider-elasticstack/pull/2027))
- Remove deprecation warning from elasticsearch_connection entity schemas ([#2100](https://github.com/elastic/terraform-provider-elasticstack/pull/2100))
- feat: add esql_control_config panel type to kibana_dashboard resource ([#2075](https://github.com/elastic/terraform-provider-elasticstack/pull/2075))
- Add support for SLO burn panel. ([#2069](https://github.com/elastic/terraform-provider-elasticstack/pull/2069))
- fix: resolve anomaly detection job plan/apply inconsistencies ([#2034](https://github.com/elastic/terraform-provider-elasticstack/pull/2034))
- Add time slider control ([#2026](https://github.com/elastic/terraform-provider-elasticstack/pull/2026))
- Attempt to recover on data view creation failures. ([#2024](https://github.com/elastic/terraform-provider-elasticstack/pull/2024))
- Alert flapping ([#1966](https://github.com/elastic/terraform-provider-elasticstack/pull/1966))
- Add `elasticsearch_connection` block to all ES based entities. ([#1954](https://github.com/elastic/terraform-provider-elasticstack/pull/1954))
- Add support for mosaic panels ([#1953](https://github.com/elastic/terraform-provider-elasticstack/pull/1953))
- Add support for waffle charts ([#1952](https://github.com/elastic/terraform-provider-elasticstack/pull/1952))
- feat: add an experimental flag to skip synthetics location validation ([#1924](https://github.com/elastic/terraform-provider-elasticstack/pull/1924))
- Fix termField validation for alert rules ([#1914](https://github.com/elastic/terraform-provider-elasticstack/pull/1914))
- Fix nil pointer panic in getPackageInfo ([#1913](https://github.com/elastic/terraform-provider-elasticstack/pull/1913))
- Fix index template alias routing ([#1841](https://github.com/elastic/terraform-provider-elasticstack/pull/1841))
- Implement fleet_output data source ([#1762](https://github.com/elastic/terraform-provider-elasticstack/pull/1762))
