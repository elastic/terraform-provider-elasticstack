...
- Add `elasticstack_kibana_agentbuilder_tool` resource and `elasticstack_kibana_export_agentbuilder_tool` data source ([#2111](https://github.com/elastic/terraform-provider-elasticstack/pull/2111))
