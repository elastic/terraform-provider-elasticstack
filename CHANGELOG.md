...
- Fix state inconsistency with empty sets and default boolean values in `elasticstack_elasticsearch_security_role` ([#1679](https://github.com/elastic/terraform-provider-elasticstack/pull/1679))
