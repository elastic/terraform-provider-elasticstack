...
- Rename fleet package objects to `elasticstack_fleet_integration` and `elasticstack_fleet_integration_policy` ([#1](https://github.com/elastic/terraform-provider-elasticstack/pull/1))
