...
- Validate endpoint presence in scoped client accessors ([#2337](https://github.com/elastic/terraform-provider-elasticstack/pull/2337))
- Remove legacy `go-kibana-rest` wiring from provider clients ([#2328](https://github.com/elastic/terraform-provider-elasticstack/pull/2328))
- Migrate `elasticstack_kibana_slo` to the shared `kbapi` client ([#2323](https://github.com/elastic/terraform-provider-elasticstack/pull/2323))
...
- Support date math index names with `concrete_name` tracking in `elasticstack_elasticsearch_index` ([#2321](https://github.com/elastic/terraform-provider-elasticstack/pull/2321))
- Migrate `elasticstack_kibana_synthetics_parameter` delete operations to the generated `kbapi` client ([#2319](https://github.com/elastic/terraform-provider-elasticstack/pull/2319))
- Migrate `elasticstack_kibana_synthetics_monitor` to the generated `kbapi` client ([#2301](https://github.com/elastic/terraform-provider-elasticstack/pull/2301))
- Remove legacy broad-client bridges from provider clients ([#2304](https://github.com/elastic/terraform-provider-elasticstack/pull/2304))
- Migrate `elasticstack_kibana_security_role` to the generated `kbapi` client ([#2300](https://github.com/elastic/terraform-provider-elasticstack/pull/2300))
- Migrate `elasticstack_kibana_synthetics_private_location` to the generated `kbapi` client ([#2299](https://github.com/elastic/terraform-provider-elasticstack/pull/2299))
- Migrate Kibana space resources and data sources to the generated `kbapi` client ([#2298](https://github.com/elastic/terraform-provider-elasticstack/pull/2298))
