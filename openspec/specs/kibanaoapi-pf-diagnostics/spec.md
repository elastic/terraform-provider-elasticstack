# kibanaoapi-pf-diagnostics Specification

## Purpose
All public functions in `internal/clients/kibanaoapi/` return Plugin Framework diagnostics instead of SDK diagnostics.
## Requirements
