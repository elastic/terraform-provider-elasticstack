...
Resource implementation: `internal/kibana/dashboard` (dashboard model and `mapPanelFromAPI` in `models_panels.go` and `models.go`; `lens-dashboard-app` / REQ-035 read-write and by-value preservation in `models_lens_dashboard_app_converters.go`).
...
| `lens-dashboard-app` panel / REQ-035 | `internal/kibana/dashboard/models_lens_dashboard_app_panel.go`, `internal/kibana/dashboard/models_lens_dashboard_app_converters.go` |
