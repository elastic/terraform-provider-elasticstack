# provider-elasticsearch-scoped-client-resolution Specification

## Purpose
TBD - created by syncing change typed-elasticsearch-client-resolution. Update Purpose after archive.
