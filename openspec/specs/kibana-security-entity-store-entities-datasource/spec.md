# kibana-security-entity-store-entities-datasource Specification

## Purpose
TBD - created by archiving change kibana-security-entity-store-entity. Update Purpose after archive.
## Requirements
