# cluster-settings-resource-via-envelope Specification

## Purpose
TBD - created by archiving change es-entitycore-migration-phase3-cluster-settings. Update Purpose after archive.
## Requirements
