# Spec delta: Entity-store acceptance-test space isolation

## Context

The Security Entity Store is a singleton per Kibana space. All five entity-store acceptance-test packages previously shared the hardcoded space `"default"`, causing non-deterministic failures when the Go test runner executes packages concurrently. This delta introduces the test-isolation pattern and CI matrix requirements needed to close issue #3952.
