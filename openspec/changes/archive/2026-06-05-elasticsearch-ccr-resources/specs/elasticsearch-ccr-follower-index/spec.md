...
> New resource `elasticstack_elasticsearch_ccr_follower_index` — manages a Cross-Cluster Replication
> (CCR) follower index. CCR requires Platinum or Enterprise license (trial mode activates enterprise features).
