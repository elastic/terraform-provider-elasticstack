...
- [x] 1.1 In `internal/elasticsearch/security/api_key/models.go`, in the
...
- [x] 1.2 Apply the same `typeutils.IsKnown(model.RoleDescriptors)` guard to
...
- [x] 2.1 In `internal/elasticsearch/security/api_key/create.go`, in
...
- [x] 3.3 In `internal/elasticsearch/security/api_key/acc_test.go`, add
