...
- [x] 2.3 Run or inspect a representative verify-label workflow execution **on a branch that includes this change’s workflow revision** to confirm AWF no longer fails solely due to blocked Go module access in the review phase. (Not satisfied from CI history alone until such a run exists.)
