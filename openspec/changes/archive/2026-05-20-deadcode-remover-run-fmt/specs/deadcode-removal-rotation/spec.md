...
Define requirements for the scheduled GitHub Agentic Workflow that selects one dead-code candidate per run, removes the symbol (and optionally its companion tests), verifies the change, and opens a cleanup pull request.
