...
- [x] 2.1 In `internal/elasticsearch/watcher/watch/models.go`, change the nil-metadata branch of `fromAPIModel` from:
  ```go
...
- [x] 3.1 Add a new acceptance test `TestAccResourceWatch_nullMetadata` in
...
- [x] 3.2 Add the matching Terraform config in
...
- [x] 4.1 Run targeted Go build: `make build`.
