...
- [x] 10.3 Run the provider documentation generator (`make generate`) to produce `docs/resources/fleet_managed_integration.md`; `docs/resources/fleet_agentless_policy.md` was never present on this branch (nothing to delete)
