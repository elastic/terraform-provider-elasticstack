...
Defines the issue classifier GitHub Agentic Workflow: triggers, pre-activation gate logic, issue selection, classification categories, label application, and comment format.
