...
- [x] 2.3 Deferred: every other suite on this line passed on `9.6.0-SNAPSHOT` CI. Reconfirmed on head `fe7ba57e2` (run [`35116764333`](https://github.com/elastic/terraform-provider-elasticstack/actions/runs/35116764333); shard-0 job [`104864919731`](https://github.com/elastic/terraform-provider-elasticstack/actions/runs/35116764333/job/104864919731), shard-1 job [`104864919751`](https://github.com/elastic/terraform-provider-elasticstack/actions/runs/35116764333/job/104864919751)). The remaining in-scope failure is still `TestAccResourceDashboardXYChart_layers` (Kibana ES|QL XY Y-metric static color overwritten to `{type:auto}`). Do not skip that test in code; leave the Kibana overwrite as a follow-up ([elastic/kibana#291451](https://github.com/elastic/kibana/issues/291451); `kibana-esql-xy-static-color-issue.md`). Provider-side re-verify once that Kibana fix lands: [#4959](https://github.com/elastic/terraform-provider-elasticstack/issues/4959). Listed suites: `TestAccResourceDashboardXYChart_basic` plus the other XY suites named in issue #4902 (`_axis`, `_decorations`, `_filters`, `_fitting`, `_layers`, `_layers_reference`, `_legend_inside`, `_legend_outside`, `_chartTimeRangeLifecycle`, `_lensPresentationFields`, `TestAccResourceDashboardXYChartMinimalConfig`, `TestAccDashboardXYMetricEmptyAsNullGating`, `TestAccReproduceIssue3402`, `TestAccReproduceIssue3707`), `TestAccResourceDashboardDatatableChart`, `TestAccResourceDashboardDatatableChart_lensPresentationCrossCutting`, and minimal probes covering `Metric`, `Gauge`, `Tagcloud`, `RegionMap`, and `LegacyMetric`.
