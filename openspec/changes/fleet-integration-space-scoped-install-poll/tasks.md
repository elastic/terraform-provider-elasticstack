...
- [x] 4.5 Confirm the existing role privilege set (`fleet`/`fleetv2` all, scoped to the test space) works against a running 9.1+ stack — adjust only if the restricted user 403s on the legitimately-scoped path too. CI: run [30106180706](https://github.com/elastic/terraform-provider-elasticstack/actions/runs/30106180706) job [89533528487](https://github.com/elastic/terraform-provider-elasticstack/actions/runs/30106180706/job/89533528487) (9.1.10 shard 0, head `2f9e3238`) — `TestAccReproduceIssue4282` PASS (18.83s).
