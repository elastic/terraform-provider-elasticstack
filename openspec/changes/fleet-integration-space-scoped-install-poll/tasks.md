...
- [x] 4.5 Confirm the existing role privilege set (`fleet`/`fleetv2` all, scoped to the test space) works against a running 9.1+ stack — adjust only if the restricted user 403s on the legitimately-scoped path too. CI: run [30096554850](https://github.com/elastic/terraform-provider-elasticstack/actions/runs/30096554850) job [89492265291](https://github.com/elastic/terraform-provider-elasticstack/actions/runs/30096554850/job/89492265291) (9.1.10 shard 0) — `TestAccReproduceIssue4282` PASS (17.50s).
