...
- [x] 3.3 Run or inspect a representative `schema-coverage-rotation` workflow execution that uses the Claude + LiteLLM configuration to confirm the worker reaches `https://elastic.litellm-prod.ai/` successfully.
