...
- [ ] 1.2 Move `workflows-src/lib/*.js` to `.github/scripts/workflows/lib/` (exclude `factory-issue-module.gh.js`, `compute_issue_slots.inline.js`, `set-phase-label.inline.js`, `set-phase-label.js`)
- [ ] 1.3 Rename `workflows-src/lib/compute_issue_slots.inline.js` → `.github/scripts/workflows/lib/compute-issue-slots.js` (remove `//include: issue-slots.js` and require it)
- [ ] 1.4 Rename `workflows-src/lib/set-phase-label.inline.js` → `.github/scripts/workflows/lib/set-phase-label.js` (remove `//include: set-phase-label.js` and require it)
- [ ] 1.5 Rename `workflows-src/lib/set-phase-label.js` → `.github/scripts/workflows/lib/phase-label.js` (pure logic, update internal references)
- [ ] 1.6 Move `workflows-src/change-factory-issue/intake-constants.js` → `.github/scripts/workflows/lib/intake/change-factory-constants.js`
- [ ] 1.7 Move `workflows-src/code-factory-issue/intake-constants.js` → `.github/scripts/workflows/lib/intake/code-factory-constants.js`
- [ ] 1.8 Move `workflows-src/research-factory-issue/intake-constants.js` → `.github/scripts/workflows/lib/intake/research-factory-constants.js`
- [ ] 1.9 Move `workflows-src/reproducer-factory-issue/intake-constants.js` → `.github/scripts/workflows/lib/intake/reproducer-factory-constants.js`
- [ ] 1.10 Create `.github/scripts/workflows/provider/classify-changes.js` containing the orchestration logic from `workflows-src/provider/scripts/classify_changes.inline.js` (wrapping `lib/classify-changes.js`)
- [ ] 1.11 Create `.github/scripts/workflows/provider/gate.js` containing the orchestration logic from `workflows-src/provider/scripts/gate.inline.js` (wrapping `lib/gate-provider.js`)
- [ ] 1.12 Create `.github/scripts/workflows/workflows/classify-changes.js` containing the orchestration logic from `workflows-src/workflows/scripts/classify_changes.inline.js`
- [ ] 1.13 Create `.github/scripts/workflows/workflows/gate.js` containing the orchestration logic from `workflows-src/workflows/scripts/gate.inline.js` (wrapping `lib/gate-workflows.js`)
- [ ] 1.14 Create `.github/scripts/workflows/issue-classifier/classify-issues.js` from `workflows-src/issue-classifier/scripts/compute_issues.inline.js`
- [ ] 1.15 Create `.github/scripts/workflows/pr-changelog-check/check.js` from `workflows-src/pr-changelog-check/scripts/pr-changelog-check.inline.js`
- [ ] 1.16 Create `.github/scripts/workflows/flaky-test-catcher/catch.js` from `workflows-src/flaky-test-catcher/scripts/check_ci_failures.inline.js` (wrapping `lib/flaky-test-catcher.js` and `lib/issue-slots.js`)
- [ ] 1.17 Create `.github/scripts/workflows/changelog/` modules from `workflows-src/changelog-generation/scripts/*.inline.js`
- [ ] 1.18 Create `.github/scripts/workflows/openspec-verify/` modules from `workflows-src/openspec-verify-label/scripts/*.inline.js`
- [ ] 1.19 Create `.github/scripts/workflows/change-factory/` modules from `workflows-src/change-factory-issue/scripts/*.inline.js`
- [ ] 1.20 Create `.github/scripts/workflows/code-factory/` modules from `workflows-src/code-factory-issue/scripts/*.inline.js`
- [ ] 1.21 Create `.github/scripts/workflows/research-factory/` modules from `workflows-src/research-factory-issue/scripts/*.inline.js`
- [ ] 1.22 Create `.github/scripts/workflows/reproducer-factory/` modules from `workflows-src/reproducer-factory-issue/scripts/*.inline.js`
- [ ] 1.23 Verify all new modules use `require()` for their lib dependencies (no remaining `//include:`)
