...
- [ ] 2.1 Add `internal/elasticsearch/watcher/watch/json_defaults.go` with `populateWatcherJSONDefaults(model map[string]any) map[string]any`: a copy-on-write recursive walker over maps **and** arrays that:
