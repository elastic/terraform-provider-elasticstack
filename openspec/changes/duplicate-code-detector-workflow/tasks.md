...
- [ ] 1.1 Add the authored duplicate-code detector workflow source under `.github/workflows-src/` and register or retain its generated output in the workflow-source manifest.
...
- [ ] 3.2 Ensure maintainer-facing workflow behavior is documented through the issue labels, title prefix, cap, and actionable issue-content contract captured by the change.
