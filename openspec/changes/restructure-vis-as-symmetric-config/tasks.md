...
- [x] 3.5 Add a clear validator/diagnostic when a deprecated `drilldowns_json` attribute appears at the schema layer (e.g., via a removed-attribute notice generated by the framework, or a custom validator that surfaces a migration message in the first release after this change).
