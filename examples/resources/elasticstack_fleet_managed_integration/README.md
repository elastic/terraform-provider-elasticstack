...
Set `TF_ELASTICSTACK_INCLUDE_EXPERIMENTAL=true` in the environment before Terraform **plan**, **apply**, or **import** against these configurations (the provider omits this resource type when the variable is unset).
