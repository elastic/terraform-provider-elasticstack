...
- Expose the data source by default now that it is GA.
...
6. **Register data source by default**
  - Add the data source to provider registration in the default data sources list.
  - Remove any experimental gate references for the data source registration.
...
- Each supported output type shall be tested in an independant step within the output acceptance tests. 
