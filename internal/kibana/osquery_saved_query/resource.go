...
func newResource() *Resource {
	return &Resource{
		KibanaResource: entitycore.NewKibanaResource[osquerySavedQueryModel](
			entitycore.ComponentKibana,
			"osquery_saved_query",
			entitycore.KibanaResourceOptions[osquerySavedQueryModel]{
				Schema: getSchema,
				Read:   readOsquerySavedQuery,
				Delete: deleteOsquerySavedQuery,
				Create: createOsquerySavedQuery,
