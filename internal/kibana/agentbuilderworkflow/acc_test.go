...
func TestAccResourceAgentBuilderWorkflow(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		PreCheck: func() { acctest.PreCheckWithWorkflowsEnabled(t, agentbuilder.MinExtendedAPIVersion) },
...
func TestAccDataSourceKibanaAgentBuilderWorkflowKibanaConnection(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		PreCheck: func() {
			...
			acctest.PreCheckWithWorkflowsEnabled(t, agentbuilder.MinExtendedAPIVersion)
		},
		Steps: []resource.TestStep{
			{
				ProtoV6ProviderFactories: acctest.Providers,
