...
func (m *queryConfigModel) populateFromAPI(q *kibanaoapi.StreamQuery_ESQLDef) error {
	if q == nil {
		return nil
	}
...
func (m *queryConfigModel) toAPI() *kibanaoapi.StreamQuery_ESQLDef {
	q := &kibanaoapi.StreamQuery_ESQLDef{
