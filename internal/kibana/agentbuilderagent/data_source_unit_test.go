...
// with MinVersion equal to agentbuilder.MinCoreAPIVersion and a non-empty
// ErrorMessage.
func TestAgentDataSourceModel_GetVersionRequirements(t *testing.T) {
	...
	require.Equal(t, *agentbuilder.MinCoreAPIVersion, reqs[0].MinVersion,
		"MinVersion must equal agentbuilder.MinCoreAPIVersion")
