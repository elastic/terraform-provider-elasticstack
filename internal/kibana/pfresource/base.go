...
func Metadata(req resource.MetadataRequest, resp *resource.MetadataResponse, typeNameSuffix string) {
	resp.TypeName = fmt.Sprintf("%s_%s", req.ProviderTypeName, typeNameSuffix)
}
