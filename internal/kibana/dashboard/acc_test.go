		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckNoResourceAttr("elasticstack_kibana_dashboard.test", "panels.0.viz_config.by_value.legacy_metric_config.data_source_json"),
					resource.TestCheckNoResourceAttr("elasticstack_kibana_dashboard.test", "panels.0.viz_config.by_value.legacy_metric_config.metric_json"),
				),
			},
		},
	})
