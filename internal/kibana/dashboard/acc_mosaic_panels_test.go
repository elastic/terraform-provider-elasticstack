		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("elasticstack_kibana_dashboard.test", "panels.0.mosaic_config.query.language", "kuery"),
					resource.TestCheckResourceAttr("elasticstack_kibana_dashboard.test", "panels.0.mosaic_config.query.query", ""),
					...
					resource.TestCheckResourceAttr("elasticstack_kibana_dashboard.test", "panels.0.mosaic_config.legend.size", "medium"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("elasticstack_kibana_dashboard.test", "panels.0.mosaic_config.title", "Complete Mosaic"),
					resource.TestCheckResourceAttr("elasticstack_kibana_dashboard.test", "panels.0.mosaic_config.description", "Complete mosaic visualization"),
			...
			// 		resource.TestCheckResourceAttr("elasticstack_kibana_dashboard.test", "panels.0.mosaic_config.ignore_global_filters", "true"),
			// 		resource.TestCheckResourceAttr("elasticstack_kibana_dashboard.test", "panels.0.mosaic_config.sampling", "0.5"),
			// 		resource.TestMatchResourceAttr("elasticstack_kibana_dashboard.test", "panels.0.mosaic_config.dataset_json", regexp.MustCompile(`"type"\s*:\s*"esql"`)),
			// 		resource.TestCheckResourceAttrSet("elasticstack_kibana_dashboard.test", "panels.0.mosaic_config.group_by_json"),
			// 		resource.TestCheckResourceAttrSet("elasticstack_kibana_dashboard.test", "panels.0.mosaic_config.group_breakdown_by_json"),
			// 		resource.TestCheckResourceAttrSet("elasticstack_kibana_dashboard.test", "panels.0.mosaic_config.metrics_json"),
			// 		resource.TestCheckNoResourceAttr("elasticstack_kibana_dashboard.test", "panels.0.mosaic_config.query.language"),
			// 		resource.TestCheckNoResourceAttr("elasticstack_kibana_dashboard.test", "panels.0.mosaic_config.query.query"),
			// 	),
			// },
			{
				ProtoV6ProviderFactories: acctest.Providers,
				...
				ImportStateVerifyIgnore: []string{
					...
					"panels.0.mosaic_config.dataset_json",
