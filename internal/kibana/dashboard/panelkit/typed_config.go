...
// PanelHasTypedConfig reports whether pm has any typed panel config block populated.
// Must stay aligned with dashboard helpers used when merging panels from API responses.
