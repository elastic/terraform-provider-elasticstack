		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("elasticstack_kibana_dashboard.test", "panels.0.treemap_config.query.language", "kql"),
					resource.TestCheckResourceAttr("elasticstack_kibana_dashboard.test", "panels.0.treemap_config.query.expression", ""),
					resource.TestCheckResourceAttrSet("elasticstack_kibana_dashboard.test", "panels.0.treemap_config.data_source_json"),
					resource.TestCheckResourceAttrSet("elasticstack_kibana_dashboard.test", "panels.0.treemap_config.group_by_json"),
					resource.TestCheckResourceAttrSet("elasticstack_kibana_dashboard.test", "panels.0.treemap_config.metrics_json"),
					resource.TestCheckResourceAttr("elasticstack_kibana_dashboard.test", "panels.0.treemap_config.legend.size", "m"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("elasticstack_kibana_dashboard.test", "panels.0.treemap_config.legend.size", "s"),
					resource.TestCheckResourceAttr("elasticstack_kibana_dashboard.test", "panels.0.treemap_config.legend.nested", "false"),
					resource.TestCheckResourceAttr("elasticstack_kibana_dashboard.test", "panels.0.treemap_config.legend.visible", "visible"),
			...
			// 		resource.TestCheckResourceAttr("elasticstack_kibana_dashboard.test", "panels.0.treemap_config.ignore_global_filters", "true"),
			// 		resource.TestCheckResourceAttr("elasticstack_kibana_dashboard.test", "panels.0.treemap_config.sampling", "0.5"),
			// 		resource.TestMatchResourceAttr("elasticstack_kibana_dashboard.test", "panels.0.treemap_config.data_source_json", regexp.MustCompile(`"type"\s*:\s*"esql"`)),
			// 		resource.TestCheckResourceAttrSet("elasticstack_kibana_dashboard.test", "panels.0.treemap_config.group_by_json"),
			// 		resource.TestCheckResourceAttrSet("elasticstack_kibana_dashboard.test", "panels.0.treemap_config.metrics_json"),
			// 		resource.TestCheckNoResourceAttr("elasticstack_kibana_dashboard.test", "panels.0.treemap_config.query.language"),
			// 		resource.TestCheckNoResourceAttr("elasticstack_kibana_dashboard.test", "panels.0.treemap_config.query.expression"),
			// 	),
			// },
			{
				ProtoV6ProviderFactories: acctest.Providers,
				...
				ImportStateVerifyIgnore: []string{
					"panels.0.treemap_config.title",
					"panels.0.treemap_config.description",
					"panels.0.treemap_config.metrics_json",
					"panels.0.treemap_config.group_by_json",
					"panels.0.treemap_config.data_source_json",
