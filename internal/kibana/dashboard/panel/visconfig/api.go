...
func (Handler) FromAPI(ctx context.Context, pm, prior *models.PanelModel, item kbapi.DashboardPanelItem) diag.Diagnostics {
	...
	default:
		...
		diags.Append(conv.PopulateFromAttributes(ctx, lensChartResolver(), &pm.VisConfig.ByValue.LensByValueChartBlocks, config0)...)
	}
...
func (Handler) ToAPI(pm models.PanelModel, _ *models.DashboardModel) (kbapi.DashboardPanelItem, diag.Diagnostics) {
	...
	case cfg.ByValue != nil:
		...
		config0, d := conv.BuildAttributes(blocks, lensChartResolver())
		diags.Append(d...)
		if d.HasError() {
			return kbapi.DashboardPanelItem{}, diags
		}
