...
func Test_PopulateFromAPI_nilBlock_emptyAPIConfig(t *testing.T) {
	pm := &models.PanelModel{}
	tfPanel := &models.PanelModel{}
	timeslider.PopulateFromAPI(pm, tfPanel, apiTimeSliderConfig(nil, nil, nil))
...
func Test_PopulateFromAPI_nilBlock_withAPIData(t *testing.T) {
	pm := &models.PanelModel{}
	tfPanel := &models.PanelModel{}
	timeslider.PopulateFromAPI(pm, tfPanel, apiTimeSliderConfig(new(float32(0.1)), new(float32(0.9)), new(true)))
	assert.Nil(t, pm.TimeSliderControlConfig)
}

// Test: on import (tfPanel == nil) with API data, populate block from API.
func Test_PopulateFromAPI_import_withAPIData(t *testing.T) {
	pm := &models.PanelModel{}
	timeslider.PopulateFromAPI(pm, nil, apiTimeSliderConfig(new(float32(0.1)), new(float32(0.9)), new(true)))
...
func Test_PopulateFromAPI_import_emptyAPIConfig(t *testing.T) {
	pm := &models.PanelModel{}
	timeslider.PopulateFromAPI(pm, nil, apiTimeSliderConfig(nil, nil, nil))
	assert.Nil(t, pm.TimeSliderControlConfig)
}

// Test: when config block exists with known fields, populate from API.
func Test_PopulateFromAPI_knownFields_populatedFromAPI(t *testing.T) {
	pm := &models.PanelModel{
	...
	timeslider.PopulateFromAPI(pm, tfPanel, apiTimeSliderConfig(new(float32(0.2)), new(float32(0.8)), new(true)))
	require.NotNil(t, pm.TimeSliderControlConfig)
...
func Test_PopulateFromAPI_nullFields_preservedAsNull(t *testing.T) {
	...
	tfPanel := &models.PanelModel{TimeSliderControlConfig: pm.TimeSliderControlConfig}
	timeslider.PopulateFromAPI(pm, tfPanel, apiTimeSliderConfig(new(float32(0.5)), new(float32(0.5)), new(true)))
	require.NotNil(t, pm.TimeSliderControlConfig)
...
func Test_PopulateFromAPI_mixedFields(t *testing.T) {
	pm := &models.PanelModel{
		TimeSliderControlConfig: &models.TimeSliderControlConfigModel{
			StartPercentageOfTimeRange: types.Float32Value(0.1),
			EndPercentageOfTimeRange:   types.Float32Null(),
...
// Test: BuildConfig sets known fields and omits null fields.
func Test_BuildConfig_knownFields(t *testing.T) {
	pm := models.PanelModel{
		TimeSliderControlConfig: &models.TimeSliderControlConfigModel{
	...
	timeslider.BuildConfig(pm, &tsPanel)
...
// Test: BuildConfig omits null fields.
func Test_BuildConfig_nullFields(t *testing.T) {
	pm := models.PanelModel{
		TimeSliderControlConfig: &models.TimeSliderControlConfigModel{
			StartPercentageOfTimeRange: types.Float32Null(),
			EndPercentageOfTimeRange:   types.Float32Null(),
...
func Test_BuildConfig_boundaryValues(t *testing.T) {
	pm := models.PanelModel{
		TimeSliderControlConfig: &models.TimeSliderControlConfigModel{
...
func Test_timeSliderPercentage_float32RoundTrip_writeThenRead(t *testing.T) {
	...
	timeslider.PopulateFromAPI(out, tfPanel, tsPanel.Config)
