...
// ml_single_metric_viewer panels. Empirical testing showed Kibana 9.4.0 rejects this
// panel type (HTTP 400); 9.5.0-SNAPSHOT accepts it. See REQ-048 compatibility
