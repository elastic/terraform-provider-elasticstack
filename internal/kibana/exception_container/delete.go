...
func (r *exceptionContainerResource) Delete(ctx context.Context, request resource.DeleteRequest, response *resource.DeleteResponse) {
	...
	resp, err := oapiClient.API.DeleteExceptionListWithResponse(ctx, params)
	if err != nil {
