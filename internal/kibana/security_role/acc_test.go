		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemAttr("elasticstack_kibana_security_role.test", "elasticsearch.0.cluster.*", "create_snapshot"),
					resource.TestCheckTypeSetElemAttr("elasticstack_kibana_security_role.test", "elasticsearch.0.indices.*.privileges.*", "create"),
					resource.TestCheckTypeSetElemAttr("elasticstack_kibana_security_role.test", "elasticsearch.0.indices.*.privileges.*", "read"),
					resource.TestCheckTypeSetElemAttr("elasticstack_kibana_security_role.test", "elasticsearch.0.indices.*.privileges.*", "write"),
