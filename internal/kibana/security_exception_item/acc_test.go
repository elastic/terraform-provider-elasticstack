	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("elasticstack_kibana_security_exception_item.test", "entries.#", "1"),
					resource.TestCheckResourceAttr("elasticstack_kibana_security_exception_item.test", "entries.0.type", "nested"),
					resource.TestCheckResourceAttr("elasticstack_kibana_security_exception_item.test", "entries.0.field", "parent.field"),
					resource.TestCheckResourceAttr("elasticstack_kibana_security_exception_item.test", "entries.0.entries.#", "3"),
					resource.TestCheckResourceAttr("elasticstack_kibana_security_exception_item.test", "entries.0.entries.0.type", "match"),
					resource.TestCheckResourceAttr("elasticstack_kibana_security_exception_item.test", "entries.0.entries.0.field", "nested.field1"),
					resource.TestCheckResourceAttr("elasticstack_kibana_security_exception_item.test", "entries.0.entries.0.operator", "included"),
					resource.TestCheckResourceAttr("elasticstack_kibana_security_exception_item.test", "entries.0.entries.0.value", "nested-value-1"),
					resource.TestCheckResourceAttr("elasticstack_kibana_security_exception_item.test", "entries.0.entries.1.type", "match_any"),
					resource.TestCheckResourceAttr("elasticstack_kibana_security_exception_item.test", "entries.0.entries.1.field", "nested.field2"),
					resource.TestCheckResourceAttr("elasticstack_kibana_security_exception_item.test", "entries.0.entries.1.operator", "included"),
					resource.TestCheckResourceAttr("elasticstack_kibana_security_exception_item.test", "entries.0.entries.1.values.#", "3"),
					resource.TestCheckResourceAttr("elasticstack_kibana_security_exception_item.test", "entries.0.entries.1.values.0", "value-a"),
					resource.TestCheckResourceAttr("elasticstack_kibana_security_exception_item.test", "entries.0.entries.1.values.1", "value-b"),
					resource.TestCheckResourceAttr("elasticstack_kibana_security_exception_item.test", "entries.0.entries.1.values.2", "value-c"),
					resource.TestCheckResourceAttr("elasticstack_kibana_security_exception_item.test", "entries.0.entries.2.type", "exists"),
					resource.TestCheckResourceAttr("elasticstack_kibana_security_exception_item.test", "entries.0.entries.2.field", "nested.field3"),
					resource.TestCheckResourceAttr("elasticstack_kibana_security_exception_item.test", "entries.0.entries.2.operator", "included"),
				),
			},
		},
	})
