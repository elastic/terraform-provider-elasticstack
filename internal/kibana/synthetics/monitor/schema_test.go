...
func TestToModelV0(t *testing.T) {
	testcases := []struct {
		...
		{
			name: "HTTP monitor with 10s schedule",
			input: kbapi.SyntheticsMonitor{
				Id:       "test-id-10s",
				Name:     "test-name-10s",
				Type:     kbapi.Http,
				Schedule: &kbapi.MonitorScheduleConfig{Number: "10", Unit: "s"},
				Url:      "https://example.com",
			},
			expected: tfModelV0{
				ID:             types.StringValue("default/test-id-10s"),
				Name:           types.StringValue("test-name-10s"),
				SpaceID:        types.StringValue("default"),
				Namespace:      types.StringValue(""),
				Schedule:       types.Float64Value(0.1),
				Labels:         types.MapNull(types.StringType),
				APMServiceName: types.StringValue(""),
				TimeoutSeconds: types.Int64Value(0),
				Params:         jsontypes.NewNormalizedValue("null"),
		...
		{
			name: "HTTP monitor with 30s schedule",
			input: kbapi.SyntheticsMonitor{
				Id:       "test-id-30s",
				Name:     "test-name-30s",
				Type:     kbapi.Http,
				Schedule: &kbapi.MonitorScheduleConfig{Number: "30", Unit: "s"},
				Url:      "https://example.com",
			},
			expected: tfModelV0{
				ID:             types.StringValue("default/test-id-30s"),
				Name:           types.StringValue("test-name-30s"),
				SpaceID:        types.StringValue("default"),
				Namespace:      types.StringValue(""),
				Schedule:       types.Float64Value(0.5),
				Labels:         types.MapNull(types.StringType),
				APMServiceName: types.StringValue(""),
				TimeoutSeconds: types.Int64Value(0),
				Params:         jsontypes.NewNormalizedValue("null"),
