...
func TestResource_importState_passthroughCompoundID(t *testing.T) {
	...
	const importID = "sample-space/loc-id-with-slash"
...
func TestResource_update_notSupported(t *testing.T) {
	t.Parallel()
	...
	require.Contains(t, resp.Diagnostics.Errors()[0].Summary(), "update not supported")
}
