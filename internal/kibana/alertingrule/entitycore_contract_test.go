...
func TestAlertingRuleModel_satisfiesKibanaResourceModel(t *testing.T) {
	t.Parallel()
	var _ entitycore.KibanaResourceModel = alertingRuleModel{}
}

func TestAlertingRuleModel_satisfiesWithVersionRequirements(t *testing.T) {
	t.Parallel()
	var _ entitycore.WithVersionRequirements = alertingRuleModel{}
}

func TestAlertingRuleResource_embedsEntityCoreKibanaResource(t *testing.T) {
	t.Parallel()
	rt := reflect.TypeFor[Resource]()
	field, ok := rt.FieldByName("KibanaResource")
	require.True(t, ok, "Resource should embed *entitycore.KibanaResource[alertingRuleModel] as field KibanaResource")
	require.True(t, field.Anonymous)
	require.Equal(t, reflect.TypeFor[*entitycore.KibanaResource[alertingRuleModel]](), field.Type)
}
...
func TestNewResource_satisfiesFrameworkInterfaces(t *testing.T) {
	...
	var _ resource.ResourceWithValidateConfig = newResource()
