...
// NewTuningParamsFromModel builds a TuningParams from the 10 common CCR tuning
// fields as they appear on the followerindex/autofollow Terraform models.
func NewTuningParamsFromModel(
	maxOutstandingReadRequests types.Int64,
	maxOutstandingWriteRequests types.Int64,
	maxReadRequestOperationCount types.Int64,
	maxReadRequestSize types.String,
