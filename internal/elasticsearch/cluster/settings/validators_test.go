...
func TestSettingObjectValidator_BothValues_Error(t *testing.T) {
	ctx := context.Background()
	v := settingObjectValidator{}

	obj, diags := types.ObjectValue(settingModelAttrTypes(), map[string]attr.Value{
		"name":       types.StringValue("key"),
		"value":      types.StringValue("val"),
		"value_list": types.ListValueMust(types.StringType, []attr.Value{types.StringValue("a")}),
	})
	if diags.HasError() {
...
func TestSettingObjectValidator_NeitherValue_Error(t *testing.T) {
	ctx := context.Background()
	v := settingObjectValidator{}
...
func TestSettingObjectValidator_OnlyValue_OK(t *testing.T) {
	ctx := context.Background()
	v := settingObjectValidator{}
...
func TestSettingObjectValidator_OnlyValueList_OK(t *testing.T) {
	ctx := context.Background()
	v := settingObjectValidator{}
