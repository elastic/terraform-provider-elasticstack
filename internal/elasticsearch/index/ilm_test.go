		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckNoResourceAttr("elasticstack_elasticsearch_index_lifecycle.test", "hot.0.downsample.0.wait_timeout"),
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_lifecycle.test", "hot.0.rollover.0.max_age", "1d"),
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_lifecycle.test", "hot.0.readonly.0.enabled", "true"),
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_lifecycle.test", "delete.0.min_age", "0ms"),
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_lifecycle.test", "hot.#", "1"),
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_lifecycle.test_meta", "name", policyName),
					resource.TestCheckNoResourceAttr("elasticstack_elasticsearch_index_lifecycle.test_meta", "metadata"),
					resource.TestCheckResourceAttrSet("elasticstack_elasticsearch_index_lifecycle.test_meta", "modified_date"),
				),
			},
		},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckNoResourceAttr("elasticstack_elasticsearch_index_lifecycle.test_hot_actions", "hot.0.shrink.0.max_primary_shard_size"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_lifecycle.test_hot_actions", "hot.0.forcemerge.0.index_codec", "best_compression"),
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_lifecycle.test_hot_actions", "hot.0.shrink.#", "1"),
					resource.TestCheckNoResourceAttr("elasticstack_elasticsearch_index_lifecycle.test_hot_actions", "hot.0.shrink.0.number_of_shards"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckNoResourceAttr("elasticstack_elasticsearch_index_lifecycle.test_warm_actions", "warm.0.shrink.0.max_primary_shard_size"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckNoResourceAttr("elasticstack_elasticsearch_index_lifecycle.test_warm_actions", "warm.0.allocate.0.include"),
					resource.TestCheckNoResourceAttr("elasticstack_elasticsearch_index_lifecycle.test_warm_actions", "warm.0.allocate.0.require"),
					...
					resource.TestCheckNoResourceAttr("elasticstack_elasticsearch_index_lifecycle.test_warm_actions", "warm.0.downsample.0.wait_timeout"),
					resource.TestCheckNoResourceAttr("elasticstack_elasticsearch_index_lifecycle.test_warm_actions", "warm.0.shrink.0.number_of_shards"),
					...
					resource.TestCheckNoResourceAttr("elasticstack_elasticsearch_index_lifecycle.test_warm_actions", "warm.0.shrink.0.allow_write_after_shrink"),
					resource.TestCheckResourceAttrSet("elasticstack_elasticsearch_index_lifecycle.test_warm_actions", "modified_date"),
				),
			},
		},
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckNoResourceAttr("elasticstack_elasticsearch_index_lifecycle.test_cold_actions", "cold.0.allocate.0.include"),
					resource.TestCheckNoResourceAttr("elasticstack_elasticsearch_index_lifecycle.test_cold_actions", "cold.0.allocate.0.exclude"),
					resource.TestCheckNoResourceAttr("elasticstack_elasticsearch_index_lifecycle.test_cold_actions", "cold.0.allocate.0.require"),
					...
					resource.TestCheckNoResourceAttr("elasticstack_elasticsearch_index_lifecycle.test_cold_actions", "cold.0.downsample.0.wait_timeout"),
					resource.TestCheckResourceAttrSet("elasticstack_elasticsearch_index_lifecycle.test_cold_actions", "modified_date"),
				),
			},
		},
