...
var (
	_ resource.Resource                = newDataStreamResource()
	_ resource.ResourceWithConfigure   = newDataStreamResource()
	_ resource.ResourceWithImportState = newDataStreamResource()
)
...
// NewDataStreamResource returns a new Plugin Framework resource for elasticstack_elasticsearch_data_stream.
func NewDataStreamResource() resource.Resource {
	return newDataStreamResource()
}
