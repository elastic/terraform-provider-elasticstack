		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "priority", "100"),
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "version", "5"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "name", templateName),
					resource.TestCheckNoResourceAttr("elasticstack_elasticsearch_index_template.test", "priority"),
					...
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "template.alias.#", "2"),
					resource.TestCheckTypeSetElemNestedAttrs(
						"elasticstack_elasticsearch_index_template.test",
						"template.alias.*",
						map[string]string{"name": "my_template_test"},
...
func TestAccResourceIndexTemplateMetadataAndMappings(t *testing.T) {
	templateName := sdkacctest.RandStringFromCharSet(10, sdkacctest.CharSetAlphaNum)
	updatedMetadata := `{"description":"updated template","owner":"team-b"}`
	updatedMappings := `{"properties":{"log_level":{"type":"keyword"},"severity":{"type":"integer"}}}`
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "template.mappings", `{"properties":{"log_level":{"type":"keyword"}}}`),
				),
			},
			{
				ProtoV6ProviderFactories: acctest.Providers,
				...
				ConfigVariables: config.Variables{
					"template_name":    config.StringVariable(templateName),
					"metadata":         config.StringVariable(updatedMetadata),
					"mappings":         config.StringVariable(updatedMappings),
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "metadata", updatedMetadata),
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "template.mappings", updatedMappings),
				),
			},
			{
				ProtoV6ProviderFactories: acctest.Providers,
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemAttr("elasticstack_elasticsearch_index_template.test", "index_patterns.*", fmt.Sprintf("%s-a-*", templateName)),
					resource.TestCheckTypeSetElemAttr("elasticstack_elasticsearch_index_template.test", "index_patterns.*", fmt.Sprintf("%s-b-*", templateName)),
					testCheckAttrEmptyOrAbsent("metadata"),
					resource.TestCheckNoResourceAttr("elasticstack_elasticsearch_index_template.test", "version"),
					testCheckAttrEmptyOrAbsent("template.mappings"),
				),
			},
			{
				ProtoV6ProviderFactories: acctest.Providers,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "name", templateName),
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "template.lifecycle.data_retention", "30d"),
				),
			},
			{
				ProtoV6ProviderFactories: acctest.Providers,
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "name", templateName),
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "template.lifecycle.data_retention", "60d"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "name", templateName),
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "template.data_stream_options.failure_store.enabled", "true"),
				),
			},
			{
				ProtoV6ProviderFactories: acctest.Providers,
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "template.data_stream_options.failure_store.enabled", "false"),
				),
			},
			{
				ProtoV6ProviderFactories: acctest.Providers,
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "template.data_stream_options.failure_store.enabled", "true"),
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "template.data_stream_options.failure_store.lifecycle.data_retention", "14d"),
				),
			},
			{
				ProtoV6ProviderFactories: acctest.Providers,
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "template.data_stream_options.failure_store.enabled", "true"),
					resource.TestCheckNoResourceAttr("elasticstack_elasticsearch_index_template.test", "template.data_stream_options.failure_store.lifecycle.data_retention"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "name", templateName),
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "data_stream.allow_custom_routing", "true"),
				),
			},
			{
				ProtoV6ProviderFactories: acctest.Providers,
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "name", templateName),
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "data_stream.allow_custom_routing", "false"),
				),
			},
		},
	})
...
func TestAccResourceIndexTemplateAllowAutoCreate(t *testing.T) {
	templateName := sdkacctest.RandStringFromCharSet(10, sdkacctest.CharSetAlphaNum)
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "name", templateName),
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "allow_auto_create", "true"),
				),
			},
			{
				ProtoV6ProviderFactories: acctest.Providers,
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "name", templateName),
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "allow_auto_create", "false"),
				),
			},
			{
				ProtoV6ProviderFactories: acctest.Providers,
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "name", templateName),
					testCheckAttrEmptyOrAbsent("template.mappings"),
					testCheckAttrEmptyOrAbsent("template.settings"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "name", templateName),
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "data_stream.hidden", "true"),
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "data_stream.allow_custom_routing", "true"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "name", templateName),
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "data_stream.hidden", "false"),
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "data_stream.allow_custom_routing", "false"),
				),
			},
		},
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemAttr("elasticstack_elasticsearch_index_template.test", "composed_of.*", fmt.Sprintf("%s-comp-a@custom", templateName)),
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "ignore_missing_component_templates.#", "1"),
					resource.TestCheckTypeSetElemAttr("elasticstack_elasticsearch_index_template.test", "ignore_missing_component_templates.*", fmt.Sprintf("%s-comp-b@custom", templateName)),
				),
			},
			{
				ProtoV6ProviderFactories: acctest.Providers,
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemAttr("elasticstack_elasticsearch_index_template.test", "composed_of.*", fmt.Sprintf("%s-comp-a@custom", templateName)),
					resource.TestCheckTypeSetElemAttr("elasticstack_elasticsearch_index_template.test", "composed_of.*", fmt.Sprintf("%s-comp-b@custom", templateName)),
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "ignore_missing_component_templates.#", "2"),
					resource.TestCheckTypeSetElemAttr("elasticstack_elasticsearch_index_template.test", "ignore_missing_component_templates.*", fmt.Sprintf("%s-comp-b@custom", templateName)),
					resource.TestCheckTypeSetElemAttr("elasticstack_elasticsearch_index_template.test", "ignore_missing_component_templates.*", fmt.Sprintf("%s-comp-c@custom", templateName)),
				),
			},
		},
	})
...
func TestAccResourceIndexTemplatePriorityZeroBoundary(t *testing.T) {
	templateName := sdkacctest.RandStringFromCharSet(10, sdkacctest.CharSetAlphaNum)
		...
		Steps: []resource.TestStep{
			{
				...
				ConfigVariables: config.Variables{
					"template_name": config.StringVariable(templateName),
					"priority":      config.IntegerVariable(0),
				},
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("elasticstack_elasticsearch_index_template.test", "name", templateName),
...
func testCheckNoTemplateAliases(resourceName string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		for key, value := range rs.Primary.Attributes {
			if strings.HasPrefix(key, "template.alias.") && strings.HasSuffix(key, ".name") && value != "" {
...
func testCheckDataStreamAttrFalseOrAbsent(resourceName, attrName string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		value, ok := rs.Primary.Attributes["data_stream."+attrName]
		if ok && value != falseValue && value != "" {
			return fmt.Errorf("expected data_stream.%s to be false or absent, got %q", attrName, value)
		}
		return nil
	}
}

func testCheckAttrEmptyOrAbsent(attrName string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		const resourceName = "elasticstack_elasticsearch_index_template.test"
		rs, ok := s.RootModule().Resources[resourceName]
		if !ok {
...
func testCheckAttrZeroOrAbsent(resourceName, attrName string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		rs, ok := s.RootModule().Resources[resourceName]
		if !ok {
			return fmt.Errorf("resource not found in state: %s", resourceName)
		...
		value, ok := rs.Primary.Attributes[attrName]
		if ok && value != "" && value != "0" {
			return fmt.Errorf("expected %s to be zero or absent, got %q", attrName, value)
		}
		return nil
	}
}
...
func templateAliasPrefix(s *terraform.State, resourceName, aliasName string) (string, error) {
	...
	for key, value := range rs.Primary.Attributes {
		if strings.HasPrefix(key, "template.alias.") && strings.HasSuffix(key, ".name") && value == aliasName {
