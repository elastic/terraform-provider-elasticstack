...
func TestAccResourceAnomalyDetectionJobEmptyInfluencersUpdate(t *testing.T) {
	jobID := fmt.Sprintf("test-anomaly-detector-empty-influencers-%s", sdkacctest.RandStringFromCharSet(10, sdkacctest.CharSetAlphaNum))
