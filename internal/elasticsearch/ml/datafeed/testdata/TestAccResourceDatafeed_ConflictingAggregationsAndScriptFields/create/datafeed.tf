...
# Setting both aggregations and script_fields must be rejected by the
# ConflictsWith validator before apply, so no anomaly detection job needs
# to exist for this negative test.
