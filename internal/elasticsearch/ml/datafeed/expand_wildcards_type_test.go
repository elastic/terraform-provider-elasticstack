...
func TestExpandWildcardsSemanticEquals_UnknownHandling(t *testing.T) {
	ctx := context.Background()

	expandWildcardsType, ok := makeExpandWildcardsValue(t, "open").Type(ctx).(datafeed.ExpandWildcardsType)
	require.True(t, ok)
