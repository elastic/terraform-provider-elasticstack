...
# Update the state of the ML job to closed with a generous, explicit update timeout,
# exercising the timeouts.update happy path (as opposed to only ExpectError cases).
