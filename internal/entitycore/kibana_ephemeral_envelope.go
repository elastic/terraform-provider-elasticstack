...
// KibanaEphemeralModel is the type constraint for models passed to a
// [KibanaEphemeralResource]. Concrete types must provide GetKibanaConnection,
...
// KibanaEphemeralOptions configures a [KibanaEphemeralResource].
// Schema, Open, and Close must be non-nil.
