...
func getOutputsDataSourceSchema() schema.Schema {
	return schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"output_id": schema.StringAttribute{
				MarkdownDescription: "Filter outputs by output ID.",
				Optional:            true,
			},
			"type": schema.StringAttribute{
				MarkdownDescription: "Filter outputs by type.",
				Optional:            true,
			},
			"default_integrations": schema.BoolAttribute{
				MarkdownDescription: "Filter outputs by default integrations output.",
				Optional:            true,
			},
			"default_monitoring": schema.BoolAttribute{
				MarkdownDescription: "Filter outputs by default monitoring output.",
				Optional:            true,
			},
			...
			"items": schema.ListNestedAttribute{
				MarkdownDescription: "Matching Fleet outputs.",
				Computed:            true,
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"id": schema.StringAttribute{
							MarkdownDescription: "The output ID.",
							Computed:            true,
						},
