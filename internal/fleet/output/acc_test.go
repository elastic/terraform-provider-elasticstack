...
func TestAccDataSourceFleetOutputElasticsearch(t *testing.T) {
	policyName := sdkacctest.RandString(22)
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "id", fmt.Sprintf("%s-elasticsearch-output", policyName)),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "output_id", fmt.Sprintf("%s-elasticsearch-output", policyName)),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "name", fmt.Sprintf("Elasticsearch Output %s", policyName)),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "type", "elasticsearch"),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "config_yaml", "\"ssl.verification_mode\": \"none\"\n"),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "default_integrations", "false"),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "default_monitoring", "false"),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "hosts.0", "https://elasticsearch:9200"),
				),
			},
		},
	})
...
func TestAccDataSourceFleetOutputLogstash(t *testing.T) {
	policyName := sdkacctest.RandString(22)
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "id", fmt.Sprintf("%s-logstash-output", policyName)),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "output_id", fmt.Sprintf("%s-logstash-output", policyName)),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "name", fmt.Sprintf("Logstash Output %s", policyName)),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "type", "logstash"),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "config_yaml", "\"ssl.verification_mode\": \"none\"\n"),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "default_integrations", "false"),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "default_monitoring", "false"),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "hosts.0", "logstash:5044"),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "ssl.certificate_authorities.0", "placeholder"),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "ssl.certificate", "placeholder"),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "ssl.key", "placeholder"),
				),
			},
		},
	})
...
func TestAccDataSourceFleetOutputKafka(t *testing.T) {
	policyName := sdkacctest.RandString(22)
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "id", fmt.Sprintf("%s-kafka-output", policyName)),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "output_id", fmt.Sprintf("%s-kafka-output", policyName)),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "name", fmt.Sprintf("Kafka Output %s", policyName)),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "type", "kafka"),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "config_yaml", "\"ssl.verification_mode\": \"none\"\n"),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "default_integrations", "false"),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "default_monitoring", "false"),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "hosts.0", "kafka:9092"),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "kafka.auth_type", "none"),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "kafka.topic", "beats"),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "kafka.partition", "hash"),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "kafka.compression", "gzip"),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "kafka.compression_level", "6"),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "kafka.connection_type", "plaintext"),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "kafka.required_acks", "1"),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "kafka.headers.0.key", "environment"),
					resource.TestCheckResourceAttr("data.elasticstack_fleet_output.test_output", "kafka.headers.0.value", "test"),
				),
			},
		},
	})
