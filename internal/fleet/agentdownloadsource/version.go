...
func (r *Resource) assertVersionSupported(ctx context.Context) diag.Diagnostics {
	...
	return diag.Diagnostics{
		diag.NewErrorDiagnostic(
			"Unsupported version for Fleet agent download source",
			fmt.Sprintf("This resource requires stack version %s or higher.", MinVersionFleetAgentDownloadSource.String()),
		),
	}
}
