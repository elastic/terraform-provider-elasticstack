...
// export_test.go exposes internal functions for white-box unit tests in the
// _test package. This file is only compiled during testing.
...
// DefendPrivateState is the exported alias for testing.
