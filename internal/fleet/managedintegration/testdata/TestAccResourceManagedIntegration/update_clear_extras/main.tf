...
resource "elasticstack_fleet_managed_integration" "test" {
  ...
  # Matches "update_flag_only" (skip_topology_check) but omits global_data_tags and
  # additional_datastreams_permissions to exercise optional collection clearing.
