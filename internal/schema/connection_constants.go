...
const (
	...
	attrCAFile                 = "ca_file"
	attrCAData                 = "ca_data"
	attrCAFingerprint          = "ca_fingerprint"
	...
	descCAFingerprint          = "SHA-256 hex fingerprint (64 hexadecimal characters, no colons or separators) of the server TLS certificate used to pin the connection instead of a full CA chain"
