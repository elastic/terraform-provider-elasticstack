...
func TestHandleGetTypedResponse(t *testing.T) {
	...
	t.Run("returns nil result on 404", func(t *testing.T) {
		result, diags := handleGetTypedResponse(http.StatusNotFound, nil, func() testAgentBuilderModel { return testAgentBuilderModel{} })
	...
	t.Run("returns diagnostics for unexpected status", func(t *testing.T) {
		result, diags := handleGetTypedResponse(http.StatusInternalServerError, []byte(`{"error":"boom"}`), func() testAgentBuilderModel { return testAgentBuilderModel{} })
...
func TestHandleMutateTypedResponse(t *testing.T) {
	...
	t.Run("returns diagnostics for unexpected status", func(t *testing.T) {
		result, diags := handleMutateTypedResponse(http.StatusNotFound, []byte(`{"error":"missing"}`), func() testAgentBuilderModel { return testAgentBuilderModel{} })
