...
type StreamDefinition struct {
	...
	Query *StreamQuery_ESQLDef `json:"query,omitempty"`
}
...
type StreamIngest struct {
	...
	Settings    StreamIngestSettings       `json:"settings,omitempty"`
...
// StreamQuery_ESQLDef holds the query definition for a query stream.
type StreamQuery_ESQLDef struct {
