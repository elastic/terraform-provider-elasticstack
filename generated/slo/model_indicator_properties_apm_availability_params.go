...
type _IndicatorPropertiesApmAvailabilityParams IndicatorPropertiesApmAvailabilityParams
...
func (o *IndicatorPropertiesApmAvailabilityParams) UnmarshalJSON(data []byte) (err error) {
	...
	varIndicatorPropertiesApmAvailabilityParams := _IndicatorPropertiesApmAvailabilityParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIndicatorPropertiesApmAvailabilityParams)

	if err != nil {
		return err
	}

	*o = IndicatorPropertiesApmAvailabilityParams(varIndicatorPropertiesApmAvailabilityParams)
