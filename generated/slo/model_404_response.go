...
type _Model404Response Model404Response
...
func (o *Model404Response) UnmarshalJSON(data []byte) (err error) {
	...
	varModel404Response := _Model404Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varModel404Response)

	if err != nil {
		return err
	}

	*o = Model404Response(varModel404Response)
