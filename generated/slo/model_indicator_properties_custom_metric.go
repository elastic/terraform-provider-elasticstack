...
type _IndicatorPropertiesCustomMetric IndicatorPropertiesCustomMetric
...
func (o *IndicatorPropertiesCustomMetric) UnmarshalJSON(data []byte) (err error) {
	...
	varIndicatorPropertiesCustomMetric := _IndicatorPropertiesCustomMetric{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIndicatorPropertiesCustomMetric)

	if err != nil {
		return err
	}

	*o = IndicatorPropertiesCustomMetric(varIndicatorPropertiesCustomMetric)
