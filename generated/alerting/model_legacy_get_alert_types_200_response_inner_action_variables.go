...
type LegacyGetAlertTypes200ResponseInnerActionVariables struct {
	Context []GetRuleTypes200ResponseInnerActionVariablesParamsInner `json:"context,omitempty"`
...
// SetContext gets a reference to the given []GetRuleTypes200ResponseInnerActionVariablesParamsInner and assigns it to the Context field.
