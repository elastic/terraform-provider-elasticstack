...
func main() {
    ...
    createRuleRequest := openapiclient.create_rule_request{CreateAnomalyDetectionAlertRuleRequest: openapiclient.NewCreateAnomalyDetectionAlertRuleRequest("Consumer_example", "Name_example", map[string]interface{}{"key": interface{}(123)}, "RuleTypeId_example", *openapiclient.NewSchedule())} // CreateRuleRequest | 
