...
// checks if the CreateSiemQueryRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSiemQueryRuleRequest{}
...
func NewCreateSiemQueryRuleRequest(consumer string, name string, params map[string]interface{}, ruleTypeId string, schedule Schedule) *CreateSiemQueryRuleRequest {
	this := CreateSiemQueryRuleRequest{}
...
func (o *CreateSiemQueryRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateSiemQueryRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateSiemQueryRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateSiemQueryRuleRequest struct {
	value *CreateSiemQueryRuleRequest
	isSet bool
}

func (v NullableCreateSiemQueryRuleRequest) Get() *CreateSiemQueryRuleRequest {
	return v.value
}

func (v *NullableCreateSiemQueryRuleRequest) Set(val *CreateSiemQueryRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSiemQueryRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSiemQueryRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSiemQueryRuleRequest(val *CreateSiemQueryRuleRequest) *NullableCreateSiemQueryRuleRequest {
	return &NullableCreateSiemQueryRuleRequest{value: val, isSet: true}
}

func (v NullableCreateSiemQueryRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSiemQueryRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
