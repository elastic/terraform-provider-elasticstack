...
// checks if the CreateApmAnomalyRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateApmAnomalyRuleRequest{}
...
func NewCreateApmAnomalyRuleRequest(consumer string, name string, params ParamsPropertyApmAnomaly, ruleTypeId string, schedule Schedule) *CreateApmAnomalyRuleRequest {
	this := CreateApmAnomalyRuleRequest{}
...
func (o *CreateApmAnomalyRuleRequest) GetParams() ParamsPropertyApmAnomaly {
	if o == nil {
		var ret ParamsPropertyApmAnomaly
		return ret
	}
...
func (o *CreateApmAnomalyRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateApmAnomalyRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateApmAnomalyRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateApmAnomalyRuleRequest struct {
	value *CreateApmAnomalyRuleRequest
	isSet bool
}

func (v NullableCreateApmAnomalyRuleRequest) Get() *CreateApmAnomalyRuleRequest {
	return v.value
}

func (v *NullableCreateApmAnomalyRuleRequest) Set(val *CreateApmAnomalyRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateApmAnomalyRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateApmAnomalyRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateApmAnomalyRuleRequest(val *CreateApmAnomalyRuleRequest) *NullableCreateApmAnomalyRuleRequest {
	return &NullableCreateApmAnomalyRuleRequest{value: val, isSet: true}
}

func (v NullableCreateApmAnomalyRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateApmAnomalyRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
