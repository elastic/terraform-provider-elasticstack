...
// checks if the CreateApmTransactionErrorRateRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateApmTransactionErrorRateRuleRequest{}
...
func NewCreateApmTransactionErrorRateRuleRequest(consumer string, name string, params ParamsPropertyApmTransactionErrorRate, ruleTypeId string, schedule Schedule) *CreateApmTransactionErrorRateRuleRequest {
	this := CreateApmTransactionErrorRateRuleRequest{}
...
func (o *CreateApmTransactionErrorRateRuleRequest) GetParams() ParamsPropertyApmTransactionErrorRate {
	if o == nil {
		var ret ParamsPropertyApmTransactionErrorRate
		return ret
	}
...
func (o *CreateApmTransactionErrorRateRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateApmTransactionErrorRateRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateApmTransactionErrorRateRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateApmTransactionErrorRateRuleRequest struct {
	value *CreateApmTransactionErrorRateRuleRequest
	isSet bool
}

func (v NullableCreateApmTransactionErrorRateRuleRequest) Get() *CreateApmTransactionErrorRateRuleRequest {
	return v.value
}

func (v *NullableCreateApmTransactionErrorRateRuleRequest) Set(val *CreateApmTransactionErrorRateRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateApmTransactionErrorRateRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateApmTransactionErrorRateRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateApmTransactionErrorRateRuleRequest(val *CreateApmTransactionErrorRateRuleRequest) *NullableCreateApmTransactionErrorRateRuleRequest {
	return &NullableCreateApmTransactionErrorRateRuleRequest{value: val, isSet: true}
}

func (v NullableCreateApmTransactionErrorRateRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateApmTransactionErrorRateRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
