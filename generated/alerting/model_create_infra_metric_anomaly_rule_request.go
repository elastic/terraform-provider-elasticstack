...
// checks if the CreateInfraMetricAnomalyRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateInfraMetricAnomalyRuleRequest{}

// CreateInfraMetricAnomalyRuleRequest struct for CreateInfraMetricAnomalyRuleRequest
...
func NewCreateInfraMetricAnomalyRuleRequest(consumer string, name string, params map[string]interface{}, ruleTypeId string, schedule Schedule) *CreateInfraMetricAnomalyRuleRequest {
	this := CreateInfraMetricAnomalyRuleRequest{}
...
func (o *CreateInfraMetricAnomalyRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateInfraMetricAnomalyRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateInfraMetricAnomalyRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateInfraMetricAnomalyRuleRequest struct {
	value *CreateInfraMetricAnomalyRuleRequest
	isSet bool
}

func (v NullableCreateInfraMetricAnomalyRuleRequest) Get() *CreateInfraMetricAnomalyRuleRequest {
	return v.value
}

func (v *NullableCreateInfraMetricAnomalyRuleRequest) Set(val *CreateInfraMetricAnomalyRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateInfraMetricAnomalyRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateInfraMetricAnomalyRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateInfraMetricAnomalyRuleRequest(val *CreateInfraMetricAnomalyRuleRequest) *NullableCreateInfraMetricAnomalyRuleRequest {
	return &NullableCreateInfraMetricAnomalyRuleRequest{value: val, isSet: true}
}

func (v NullableCreateInfraMetricAnomalyRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateInfraMetricAnomalyRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
