...
// checks if the CreateMonitoringNodesChangedRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateMonitoringNodesChangedRuleRequest{}
...
func NewCreateMonitoringNodesChangedRuleRequest(consumer string, name string, params map[string]interface{}, ruleTypeId string, schedule Schedule) *CreateMonitoringNodesChangedRuleRequest {
	this := CreateMonitoringNodesChangedRuleRequest{}
...
func (o *CreateMonitoringNodesChangedRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateMonitoringNodesChangedRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateMonitoringNodesChangedRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateMonitoringNodesChangedRuleRequest struct {
	value *CreateMonitoringNodesChangedRuleRequest
	isSet bool
}

func (v NullableCreateMonitoringNodesChangedRuleRequest) Get() *CreateMonitoringNodesChangedRuleRequest {
	return v.value
}

func (v *NullableCreateMonitoringNodesChangedRuleRequest) Set(val *CreateMonitoringNodesChangedRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateMonitoringNodesChangedRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateMonitoringNodesChangedRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateMonitoringNodesChangedRuleRequest(val *CreateMonitoringNodesChangedRuleRequest) *NullableCreateMonitoringNodesChangedRuleRequest {
	return &NullableCreateMonitoringNodesChangedRuleRequest{value: val, isSet: true}
}

func (v NullableCreateMonitoringNodesChangedRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateMonitoringNodesChangedRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
