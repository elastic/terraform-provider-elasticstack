...
// checks if the CreateMonitoringCcrExceptionsRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateMonitoringCcrExceptionsRuleRequest{}
...
func NewCreateMonitoringCcrExceptionsRuleRequest(consumer string, name string, params map[string]interface{}, ruleTypeId string, schedule Schedule) *CreateMonitoringCcrExceptionsRuleRequest {
	this := CreateMonitoringCcrExceptionsRuleRequest{}
...
func (o *CreateMonitoringCcrExceptionsRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateMonitoringCcrExceptionsRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateMonitoringCcrExceptionsRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateMonitoringCcrExceptionsRuleRequest struct {
	value *CreateMonitoringCcrExceptionsRuleRequest
	isSet bool
}

func (v NullableCreateMonitoringCcrExceptionsRuleRequest) Get() *CreateMonitoringCcrExceptionsRuleRequest {
	return v.value
}

func (v *NullableCreateMonitoringCcrExceptionsRuleRequest) Set(val *CreateMonitoringCcrExceptionsRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateMonitoringCcrExceptionsRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateMonitoringCcrExceptionsRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateMonitoringCcrExceptionsRuleRequest(val *CreateMonitoringCcrExceptionsRuleRequest) *NullableCreateMonitoringCcrExceptionsRuleRequest {
	return &NullableCreateMonitoringCcrExceptionsRuleRequest{value: val, isSet: true}
}

func (v NullableCreateMonitoringCcrExceptionsRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateMonitoringCcrExceptionsRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
