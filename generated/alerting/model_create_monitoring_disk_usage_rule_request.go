...
// checks if the CreateMonitoringDiskUsageRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateMonitoringDiskUsageRuleRequest{}
...
func NewCreateMonitoringDiskUsageRuleRequest(consumer string, name string, params map[string]interface{}, ruleTypeId string, schedule Schedule) *CreateMonitoringDiskUsageRuleRequest {
	this := CreateMonitoringDiskUsageRuleRequest{}
...
func (o *CreateMonitoringDiskUsageRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateMonitoringDiskUsageRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateMonitoringDiskUsageRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateMonitoringDiskUsageRuleRequest struct {
	value *CreateMonitoringDiskUsageRuleRequest
	isSet bool
}

func (v NullableCreateMonitoringDiskUsageRuleRequest) Get() *CreateMonitoringDiskUsageRuleRequest {
	return v.value
}

func (v *NullableCreateMonitoringDiskUsageRuleRequest) Set(val *CreateMonitoringDiskUsageRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateMonitoringDiskUsageRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateMonitoringDiskUsageRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateMonitoringDiskUsageRuleRequest(val *CreateMonitoringDiskUsageRuleRequest) *NullableCreateMonitoringDiskUsageRuleRequest {
	return &NullableCreateMonitoringDiskUsageRuleRequest{value: val, isSet: true}
}

func (v NullableCreateMonitoringDiskUsageRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateMonitoringDiskUsageRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
