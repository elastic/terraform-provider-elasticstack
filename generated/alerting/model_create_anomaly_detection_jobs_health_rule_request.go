...
// checks if the CreateAnomalyDetectionJobsHealthRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAnomalyDetectionJobsHealthRuleRequest{}
...
func NewCreateAnomalyDetectionJobsHealthRuleRequest(consumer string, name string, params map[string]interface{}, ruleTypeId string, schedule Schedule) *CreateAnomalyDetectionJobsHealthRuleRequest {
	this := CreateAnomalyDetectionJobsHealthRuleRequest{}
...
func (o *CreateAnomalyDetectionJobsHealthRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateAnomalyDetectionJobsHealthRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateAnomalyDetectionJobsHealthRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateAnomalyDetectionJobsHealthRuleRequest struct {
	value *CreateAnomalyDetectionJobsHealthRuleRequest
	isSet bool
}

func (v NullableCreateAnomalyDetectionJobsHealthRuleRequest) Get() *CreateAnomalyDetectionJobsHealthRuleRequest {
	return v.value
}

func (v *NullableCreateAnomalyDetectionJobsHealthRuleRequest) Set(val *CreateAnomalyDetectionJobsHealthRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAnomalyDetectionJobsHealthRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAnomalyDetectionJobsHealthRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAnomalyDetectionJobsHealthRuleRequest(val *CreateAnomalyDetectionJobsHealthRuleRequest) *NullableCreateAnomalyDetectionJobsHealthRuleRequest {
	return &NullableCreateAnomalyDetectionJobsHealthRuleRequest{value: val, isSet: true}
}

func (v NullableCreateAnomalyDetectionJobsHealthRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAnomalyDetectionJobsHealthRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
