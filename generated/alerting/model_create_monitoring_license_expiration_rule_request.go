...
// checks if the CreateMonitoringLicenseExpirationRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateMonitoringLicenseExpirationRuleRequest{}
...
func NewCreateMonitoringLicenseExpirationRuleRequest(consumer string, name string, params map[string]interface{}, ruleTypeId string, schedule Schedule) *CreateMonitoringLicenseExpirationRuleRequest {
	this := CreateMonitoringLicenseExpirationRuleRequest{}
...
func (o *CreateMonitoringLicenseExpirationRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateMonitoringLicenseExpirationRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateMonitoringLicenseExpirationRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateMonitoringLicenseExpirationRuleRequest struct {
	value *CreateMonitoringLicenseExpirationRuleRequest
	isSet bool
}

func (v NullableCreateMonitoringLicenseExpirationRuleRequest) Get() *CreateMonitoringLicenseExpirationRuleRequest {
	return v.value
}

func (v *NullableCreateMonitoringLicenseExpirationRuleRequest) Set(val *CreateMonitoringLicenseExpirationRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateMonitoringLicenseExpirationRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateMonitoringLicenseExpirationRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateMonitoringLicenseExpirationRuleRequest(val *CreateMonitoringLicenseExpirationRuleRequest) *NullableCreateMonitoringLicenseExpirationRuleRequest {
	return &NullableCreateMonitoringLicenseExpirationRuleRequest{value: val, isSet: true}
}

func (v NullableCreateMonitoringLicenseExpirationRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateMonitoringLicenseExpirationRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
