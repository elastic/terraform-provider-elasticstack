...
// checks if the CreateSyntheticsUptimeTlsRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSyntheticsUptimeTlsRuleRequest{}

// CreateSyntheticsUptimeTlsRuleRequest struct for CreateSyntheticsUptimeTlsRuleRequest
...
func NewCreateSyntheticsUptimeTlsRuleRequest(consumer string, name string, params ParamsPropertySyntheticsUptimeTls, ruleTypeId string, schedule Schedule) *CreateSyntheticsUptimeTlsRuleRequest {
	this := CreateSyntheticsUptimeTlsRuleRequest{}
...
func (o *CreateSyntheticsUptimeTlsRuleRequest) GetParams() ParamsPropertySyntheticsUptimeTls {
	if o == nil {
		var ret ParamsPropertySyntheticsUptimeTls
		return ret
	}
...
func (o *CreateSyntheticsUptimeTlsRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateSyntheticsUptimeTlsRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateSyntheticsUptimeTlsRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateSyntheticsUptimeTlsRuleRequest struct {
	value *CreateSyntheticsUptimeTlsRuleRequest
	isSet bool
}

func (v NullableCreateSyntheticsUptimeTlsRuleRequest) Get() *CreateSyntheticsUptimeTlsRuleRequest {
	return v.value
}

func (v *NullableCreateSyntheticsUptimeTlsRuleRequest) Set(val *CreateSyntheticsUptimeTlsRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSyntheticsUptimeTlsRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSyntheticsUptimeTlsRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSyntheticsUptimeTlsRuleRequest(val *CreateSyntheticsUptimeTlsRuleRequest) *NullableCreateSyntheticsUptimeTlsRuleRequest {
	return &NullableCreateSyntheticsUptimeTlsRuleRequest{value: val, isSet: true}
}

func (v NullableCreateSyntheticsUptimeTlsRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSyntheticsUptimeTlsRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
