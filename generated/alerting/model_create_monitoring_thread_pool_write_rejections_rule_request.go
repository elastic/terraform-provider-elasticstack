...
// checks if the CreateMonitoringThreadPoolWriteRejectionsRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateMonitoringThreadPoolWriteRejectionsRuleRequest{}
...
func NewCreateMonitoringThreadPoolWriteRejectionsRuleRequest(consumer string, name string, params map[string]interface{}, ruleTypeId string, schedule Schedule) *CreateMonitoringThreadPoolWriteRejectionsRuleRequest {
	this := CreateMonitoringThreadPoolWriteRejectionsRuleRequest{}
...
func (o *CreateMonitoringThreadPoolWriteRejectionsRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateMonitoringThreadPoolWriteRejectionsRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateMonitoringThreadPoolWriteRejectionsRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateMonitoringThreadPoolWriteRejectionsRuleRequest struct {
	value *CreateMonitoringThreadPoolWriteRejectionsRuleRequest
	isSet bool
}

func (v NullableCreateMonitoringThreadPoolWriteRejectionsRuleRequest) Get() *CreateMonitoringThreadPoolWriteRejectionsRuleRequest {
	return v.value
}

func (v *NullableCreateMonitoringThreadPoolWriteRejectionsRuleRequest) Set(val *CreateMonitoringThreadPoolWriteRejectionsRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateMonitoringThreadPoolWriteRejectionsRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateMonitoringThreadPoolWriteRejectionsRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateMonitoringThreadPoolWriteRejectionsRuleRequest(val *CreateMonitoringThreadPoolWriteRejectionsRuleRequest) *NullableCreateMonitoringThreadPoolWriteRejectionsRuleRequest {
	return &NullableCreateMonitoringThreadPoolWriteRejectionsRuleRequest{value: val, isSet: true}
}

func (v NullableCreateMonitoringThreadPoolWriteRejectionsRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateMonitoringThreadPoolWriteRejectionsRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
