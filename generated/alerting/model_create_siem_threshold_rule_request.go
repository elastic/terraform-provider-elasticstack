...
// checks if the CreateSiemThresholdRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSiemThresholdRuleRequest{}
...
func NewCreateSiemThresholdRuleRequest(consumer string, name string, params map[string]interface{}, ruleTypeId string, schedule Schedule) *CreateSiemThresholdRuleRequest {
	this := CreateSiemThresholdRuleRequest{}
...
func (o *CreateSiemThresholdRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateSiemThresholdRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateSiemThresholdRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateSiemThresholdRuleRequest struct {
	value *CreateSiemThresholdRuleRequest
	isSet bool
}

func (v NullableCreateSiemThresholdRuleRequest) Get() *CreateSiemThresholdRuleRequest {
	return v.value
}

func (v *NullableCreateSiemThresholdRuleRequest) Set(val *CreateSiemThresholdRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSiemThresholdRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSiemThresholdRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSiemThresholdRuleRequest(val *CreateSiemThresholdRuleRequest) *NullableCreateSiemThresholdRuleRequest {
	return &NullableCreateSiemThresholdRuleRequest{value: val, isSet: true}
}

func (v NullableCreateSiemThresholdRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSiemThresholdRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
