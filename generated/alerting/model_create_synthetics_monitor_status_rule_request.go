...
// checks if the CreateSyntheticsMonitorStatusRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSyntheticsMonitorStatusRuleRequest{}
...
func NewCreateSyntheticsMonitorStatusRuleRequest(consumer string, name string, params map[string]interface{}, ruleTypeId string, schedule Schedule) *CreateSyntheticsMonitorStatusRuleRequest {
	this := CreateSyntheticsMonitorStatusRuleRequest{}
...
func (o *CreateSyntheticsMonitorStatusRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateSyntheticsMonitorStatusRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateSyntheticsMonitorStatusRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateSyntheticsMonitorStatusRuleRequest struct {
	value *CreateSyntheticsMonitorStatusRuleRequest
	isSet bool
}

func (v NullableCreateSyntheticsMonitorStatusRuleRequest) Get() *CreateSyntheticsMonitorStatusRuleRequest {
	return v.value
}

func (v *NullableCreateSyntheticsMonitorStatusRuleRequest) Set(val *CreateSyntheticsMonitorStatusRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSyntheticsMonitorStatusRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSyntheticsMonitorStatusRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSyntheticsMonitorStatusRuleRequest(val *CreateSyntheticsMonitorStatusRuleRequest) *NullableCreateSyntheticsMonitorStatusRuleRequest {
	return &NullableCreateSyntheticsMonitorStatusRuleRequest{value: val, isSet: true}
}

func (v NullableCreateSyntheticsMonitorStatusRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSyntheticsMonitorStatusRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
