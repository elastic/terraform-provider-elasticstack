...
// checks if the CreateSiemMlRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSiemMlRuleRequest{}
...
func (o *CreateSiemMlRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateSiemMlRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateSiemMlRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateSiemMlRuleRequest struct {
	value *CreateSiemMlRuleRequest
	isSet bool
}

func (v NullableCreateSiemMlRuleRequest) Get() *CreateSiemMlRuleRequest {
	return v.value
}

func (v *NullableCreateSiemMlRuleRequest) Set(val *CreateSiemMlRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSiemMlRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSiemMlRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSiemMlRuleRequest(val *CreateSiemMlRuleRequest) *NullableCreateSiemMlRuleRequest {
	return &NullableCreateSiemMlRuleRequest{value: val, isSet: true}
}

func (v NullableCreateSiemMlRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSiemMlRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
