...
// checks if the CreateTransformHealthRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTransformHealthRuleRequest{}
...
func NewCreateTransformHealthRuleRequest(consumer string, name string, params map[string]interface{}, ruleTypeId string, schedule Schedule) *CreateTransformHealthRuleRequest {
	this := CreateTransformHealthRuleRequest{}
...
func (o *CreateTransformHealthRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateTransformHealthRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateTransformHealthRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateTransformHealthRuleRequest struct {
	value *CreateTransformHealthRuleRequest
	isSet bool
}

func (v NullableCreateTransformHealthRuleRequest) Get() *CreateTransformHealthRuleRequest {
	return v.value
}

func (v *NullableCreateTransformHealthRuleRequest) Set(val *CreateTransformHealthRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTransformHealthRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTransformHealthRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTransformHealthRuleRequest(val *CreateTransformHealthRuleRequest) *NullableCreateTransformHealthRuleRequest {
	return &NullableCreateTransformHealthRuleRequest{value: val, isSet: true}
}

func (v NullableCreateTransformHealthRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTransformHealthRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
