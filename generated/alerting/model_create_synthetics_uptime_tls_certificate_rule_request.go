...
// checks if the CreateSyntheticsUptimeTlsCertificateRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSyntheticsUptimeTlsCertificateRuleRequest{}
...
func NewCreateSyntheticsUptimeTlsCertificateRuleRequest(consumer string, name string, params map[string]interface{}, ruleTypeId string, schedule Schedule) *CreateSyntheticsUptimeTlsCertificateRuleRequest {
	this := CreateSyntheticsUptimeTlsCertificateRuleRequest{}
...
func (o *CreateSyntheticsUptimeTlsCertificateRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateSyntheticsUptimeTlsCertificateRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateSyntheticsUptimeTlsCertificateRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateSyntheticsUptimeTlsCertificateRuleRequest struct {
	value *CreateSyntheticsUptimeTlsCertificateRuleRequest
	isSet bool
}

func (v NullableCreateSyntheticsUptimeTlsCertificateRuleRequest) Get() *CreateSyntheticsUptimeTlsCertificateRuleRequest {
	return v.value
}

func (v *NullableCreateSyntheticsUptimeTlsCertificateRuleRequest) Set(val *CreateSyntheticsUptimeTlsCertificateRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSyntheticsUptimeTlsCertificateRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSyntheticsUptimeTlsCertificateRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSyntheticsUptimeTlsCertificateRuleRequest(val *CreateSyntheticsUptimeTlsCertificateRuleRequest) *NullableCreateSyntheticsUptimeTlsCertificateRuleRequest {
	return &NullableCreateSyntheticsUptimeTlsCertificateRuleRequest{value: val, isSet: true}
}

func (v NullableCreateSyntheticsUptimeTlsCertificateRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSyntheticsUptimeTlsCertificateRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
