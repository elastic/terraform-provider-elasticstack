...
// checks if the CreateAnomalyDetectionAlertRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAnomalyDetectionAlertRuleRequest{}
...
func NewCreateAnomalyDetectionAlertRuleRequest(consumer string, name string, params map[string]interface{}, ruleTypeId string, schedule Schedule) *CreateAnomalyDetectionAlertRuleRequest {
	this := CreateAnomalyDetectionAlertRuleRequest{}
...
func (o *CreateAnomalyDetectionAlertRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateAnomalyDetectionAlertRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateAnomalyDetectionAlertRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateAnomalyDetectionAlertRuleRequest struct {
	value *CreateAnomalyDetectionAlertRuleRequest
	isSet bool
}

func (v NullableCreateAnomalyDetectionAlertRuleRequest) Get() *CreateAnomalyDetectionAlertRuleRequest {
	return v.value
}

func (v *NullableCreateAnomalyDetectionAlertRuleRequest) Set(val *CreateAnomalyDetectionAlertRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAnomalyDetectionAlertRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAnomalyDetectionAlertRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAnomalyDetectionAlertRuleRequest(val *CreateAnomalyDetectionAlertRuleRequest) *NullableCreateAnomalyDetectionAlertRuleRequest {
	return &NullableCreateAnomalyDetectionAlertRuleRequest{value: val, isSet: true}
}

func (v NullableCreateAnomalyDetectionAlertRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAnomalyDetectionAlertRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
