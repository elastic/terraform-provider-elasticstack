...
// checks if the CreateIndexThresholdRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateIndexThresholdRuleRequest{}
...
func NewCreateIndexThresholdRuleRequest(consumer string, name string, params ParamsIndexThresholdRule, ruleTypeId string, schedule Schedule) *CreateIndexThresholdRuleRequest {
	this := CreateIndexThresholdRuleRequest{}
...
func (o *CreateIndexThresholdRuleRequest) GetParams() ParamsIndexThresholdRule {
	if o == nil {
		var ret ParamsIndexThresholdRule
		return ret
	}
...
func (o *CreateIndexThresholdRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateIndexThresholdRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateIndexThresholdRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateIndexThresholdRuleRequest struct {
	value *CreateIndexThresholdRuleRequest
	isSet bool
}

func (v NullableCreateIndexThresholdRuleRequest) Get() *CreateIndexThresholdRuleRequest {
	return v.value
}

func (v *NullableCreateIndexThresholdRuleRequest) Set(val *CreateIndexThresholdRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateIndexThresholdRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateIndexThresholdRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateIndexThresholdRuleRequest(val *CreateIndexThresholdRuleRequest) *NullableCreateIndexThresholdRuleRequest {
	return &NullableCreateIndexThresholdRuleRequest{value: val, isSet: true}
}

func (v NullableCreateIndexThresholdRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateIndexThresholdRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
