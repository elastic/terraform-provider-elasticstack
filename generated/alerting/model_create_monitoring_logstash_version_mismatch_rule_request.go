...
// checks if the CreateMonitoringLogstashVersionMismatchRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateMonitoringLogstashVersionMismatchRuleRequest{}
...
func NewCreateMonitoringLogstashVersionMismatchRuleRequest(consumer string, name string, params map[string]interface{}, ruleTypeId string, schedule Schedule) *CreateMonitoringLogstashVersionMismatchRuleRequest {
	this := CreateMonitoringLogstashVersionMismatchRuleRequest{}
...
func (o *CreateMonitoringLogstashVersionMismatchRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateMonitoringLogstashVersionMismatchRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateMonitoringLogstashVersionMismatchRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateMonitoringLogstashVersionMismatchRuleRequest struct {
	value *CreateMonitoringLogstashVersionMismatchRuleRequest
	isSet bool
}

func (v NullableCreateMonitoringLogstashVersionMismatchRuleRequest) Get() *CreateMonitoringLogstashVersionMismatchRuleRequest {
	return v.value
}

func (v *NullableCreateMonitoringLogstashVersionMismatchRuleRequest) Set(val *CreateMonitoringLogstashVersionMismatchRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateMonitoringLogstashVersionMismatchRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateMonitoringLogstashVersionMismatchRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateMonitoringLogstashVersionMismatchRuleRequest(val *CreateMonitoringLogstashVersionMismatchRuleRequest) *NullableCreateMonitoringLogstashVersionMismatchRuleRequest {
	return &NullableCreateMonitoringLogstashVersionMismatchRuleRequest{value: val, isSet: true}
}

func (v NullableCreateMonitoringLogstashVersionMismatchRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateMonitoringLogstashVersionMismatchRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
