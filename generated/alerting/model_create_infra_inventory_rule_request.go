...
// checks if the CreateInfraInventoryRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateInfraInventoryRuleRequest{}
...
func NewCreateInfraInventoryRuleRequest(consumer string, name string, params ParamsPropertyInfraInventory, ruleTypeId string, schedule Schedule) *CreateInfraInventoryRuleRequest {
	this := CreateInfraInventoryRuleRequest{}
...
func (o *CreateInfraInventoryRuleRequest) GetParams() ParamsPropertyInfraInventory {
	if o == nil {
		var ret ParamsPropertyInfraInventory
		return ret
	}
...
func (o *CreateInfraInventoryRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateInfraInventoryRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateInfraInventoryRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateInfraInventoryRuleRequest struct {
	value *CreateInfraInventoryRuleRequest
	isSet bool
}

func (v NullableCreateInfraInventoryRuleRequest) Get() *CreateInfraInventoryRuleRequest {
	return v.value
}

func (v *NullableCreateInfraInventoryRuleRequest) Set(val *CreateInfraInventoryRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateInfraInventoryRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateInfraInventoryRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateInfraInventoryRuleRequest(val *CreateInfraInventoryRuleRequest) *NullableCreateInfraInventoryRuleRequest {
	return &NullableCreateInfraInventoryRuleRequest{value: val, isSet: true}
}

func (v NullableCreateInfraInventoryRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateInfraInventoryRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
