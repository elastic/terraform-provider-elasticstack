...
// checks if the CreateSiemNotificationsRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSiemNotificationsRuleRequest{}

// CreateSiemNotificationsRuleRequest struct for CreateSiemNotificationsRuleRequest
...
func NewCreateSiemNotificationsRuleRequest(consumer string, name string, params map[string]interface{}, ruleTypeId string, schedule Schedule) *CreateSiemNotificationsRuleRequest {
	this := CreateSiemNotificationsRuleRequest{}
...
func (o *CreateSiemNotificationsRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateSiemNotificationsRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateSiemNotificationsRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateSiemNotificationsRuleRequest struct {
	value *CreateSiemNotificationsRuleRequest
	isSet bool
}

func (v NullableCreateSiemNotificationsRuleRequest) Get() *CreateSiemNotificationsRuleRequest {
	return v.value
}

func (v *NullableCreateSiemNotificationsRuleRequest) Set(val *CreateSiemNotificationsRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSiemNotificationsRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSiemNotificationsRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSiemNotificationsRuleRequest(val *CreateSiemNotificationsRuleRequest) *NullableCreateSiemNotificationsRuleRequest {
	return &NullableCreateSiemNotificationsRuleRequest{value: val, isSet: true}
}

func (v NullableCreateSiemNotificationsRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSiemNotificationsRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
