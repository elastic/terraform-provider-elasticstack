...
// checks if the CreateInfraMetricThresholdRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateInfraMetricThresholdRuleRequest{}
...
func NewCreateInfraMetricThresholdRuleRequest(consumer string, name string, params ParamsPropertyInfraMetricThreshold, ruleTypeId string, schedule Schedule) *CreateInfraMetricThresholdRuleRequest {
	this := CreateInfraMetricThresholdRuleRequest{}
...
func (o *CreateInfraMetricThresholdRuleRequest) GetParams() ParamsPropertyInfraMetricThreshold {
	if o == nil {
		var ret ParamsPropertyInfraMetricThreshold
		return ret
	}
...
func (o *CreateInfraMetricThresholdRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateInfraMetricThresholdRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateInfraMetricThresholdRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateInfraMetricThresholdRuleRequest struct {
	value *CreateInfraMetricThresholdRuleRequest
	isSet bool
}

func (v NullableCreateInfraMetricThresholdRuleRequest) Get() *CreateInfraMetricThresholdRuleRequest {
	return v.value
}

func (v *NullableCreateInfraMetricThresholdRuleRequest) Set(val *CreateInfraMetricThresholdRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateInfraMetricThresholdRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateInfraMetricThresholdRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateInfraMetricThresholdRuleRequest(val *CreateInfraMetricThresholdRuleRequest) *NullableCreateInfraMetricThresholdRuleRequest {
	return &NullableCreateInfraMetricThresholdRuleRequest{value: val, isSet: true}
}

func (v NullableCreateInfraMetricThresholdRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateInfraMetricThresholdRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
