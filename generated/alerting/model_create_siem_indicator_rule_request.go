...
// checks if the CreateSiemIndicatorRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSiemIndicatorRuleRequest{}
...
func NewCreateSiemIndicatorRuleRequest(consumer string, name string, params map[string]interface{}, ruleTypeId string, schedule Schedule) *CreateSiemIndicatorRuleRequest {
	this := CreateSiemIndicatorRuleRequest{}
...
func (o *CreateSiemIndicatorRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateSiemIndicatorRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateSiemIndicatorRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateSiemIndicatorRuleRequest struct {
	value *CreateSiemIndicatorRuleRequest
	isSet bool
}

func (v NullableCreateSiemIndicatorRuleRequest) Get() *CreateSiemIndicatorRuleRequest {
	return v.value
}

func (v *NullableCreateSiemIndicatorRuleRequest) Set(val *CreateSiemIndicatorRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSiemIndicatorRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSiemIndicatorRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSiemIndicatorRuleRequest(val *CreateSiemIndicatorRuleRequest) *NullableCreateSiemIndicatorRuleRequest {
	return &NullableCreateSiemIndicatorRuleRequest{value: val, isSet: true}
}

func (v NullableCreateSiemIndicatorRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSiemIndicatorRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
