...
// checks if the CreateGeoContainmentRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateGeoContainmentRuleRequest{}
...
func NewCreateGeoContainmentRuleRequest(consumer string, name string, params map[string]interface{}, ruleTypeId string, schedule Schedule) *CreateGeoContainmentRuleRequest {
	this := CreateGeoContainmentRuleRequest{}
...
func (o *CreateGeoContainmentRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateGeoContainmentRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateGeoContainmentRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateGeoContainmentRuleRequest struct {
	value *CreateGeoContainmentRuleRequest
	isSet bool
}

func (v NullableCreateGeoContainmentRuleRequest) Get() *CreateGeoContainmentRuleRequest {
	return v.value
}

func (v *NullableCreateGeoContainmentRuleRequest) Set(val *CreateGeoContainmentRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateGeoContainmentRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateGeoContainmentRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateGeoContainmentRuleRequest(val *CreateGeoContainmentRuleRequest) *NullableCreateGeoContainmentRuleRequest {
	return &NullableCreateGeoContainmentRuleRequest{value: val, isSet: true}
}

func (v NullableCreateGeoContainmentRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateGeoContainmentRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
