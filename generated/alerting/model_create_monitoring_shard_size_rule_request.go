...
// checks if the CreateMonitoringShardSizeRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateMonitoringShardSizeRuleRequest{}
...
func NewCreateMonitoringShardSizeRuleRequest(consumer string, name string, params map[string]interface{}, ruleTypeId string, schedule Schedule) *CreateMonitoringShardSizeRuleRequest {
	this := CreateMonitoringShardSizeRuleRequest{}
...
func (o *CreateMonitoringShardSizeRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateMonitoringShardSizeRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateMonitoringShardSizeRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateMonitoringShardSizeRuleRequest struct {
	value *CreateMonitoringShardSizeRuleRequest
	isSet bool
}

func (v NullableCreateMonitoringShardSizeRuleRequest) Get() *CreateMonitoringShardSizeRuleRequest {
	return v.value
}

func (v *NullableCreateMonitoringShardSizeRuleRequest) Set(val *CreateMonitoringShardSizeRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateMonitoringShardSizeRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateMonitoringShardSizeRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateMonitoringShardSizeRuleRequest(val *CreateMonitoringShardSizeRuleRequest) *NullableCreateMonitoringShardSizeRuleRequest {
	return &NullableCreateMonitoringShardSizeRuleRequest{value: val, isSet: true}
}

func (v NullableCreateMonitoringShardSizeRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateMonitoringShardSizeRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
