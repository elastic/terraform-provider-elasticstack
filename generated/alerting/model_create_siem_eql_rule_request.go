...
// checks if the CreateSiemEqlRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSiemEqlRuleRequest{}
...
func (o *CreateSiemEqlRuleRequest) SetThrottleNil() {
	o.Throttle.Set(nil)
}
...
func (o CreateSiemEqlRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateSiemEqlRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateSiemEqlRuleRequest struct {
	value *CreateSiemEqlRuleRequest
	isSet bool
}

func (v NullableCreateSiemEqlRuleRequest) Get() *CreateSiemEqlRuleRequest {
	return v.value
}

func (v *NullableCreateSiemEqlRuleRequest) Set(val *CreateSiemEqlRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSiemEqlRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSiemEqlRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSiemEqlRuleRequest(val *CreateSiemEqlRuleRequest) *NullableCreateSiemEqlRuleRequest {
	return &NullableCreateSiemEqlRuleRequest{value: val, isSet: true}
}

func (v NullableCreateSiemEqlRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSiemEqlRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
