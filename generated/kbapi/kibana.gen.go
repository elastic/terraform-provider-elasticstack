...
// PackagePolicyResponse defines model for package_policy_response.
type PackagePolicyResponse struct {
	union json.RawMessage
}

// PackagePolicyResponse0 defines model for .
type PackagePolicyResponse0 = []SyntheticsPostParameterResponse
...
// AsPackagePolicyResponse0 returns the union data inside the PackagePolicyResponse as a PackagePolicyResponse0
func (t PackagePolicyResponse) AsPackagePolicyResponse0() (PackagePolicyResponse0, error) {
	var body PackagePolicyResponse0
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromPackagePolicyResponse0 overwrites any union data inside the PackagePolicyResponse as the provided PackagePolicyResponse0
func (t *PackagePolicyResponse) FromPackagePolicyResponse0(v PackagePolicyResponse0) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergePackagePolicyResponse0 performs a merge with any union data inside the PackagePolicyResponse, using the provided PackagePolicyResponse0
func (t *PackagePolicyResponse) MergePackagePolicyResponse0(v PackagePolicyResponse0) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsSyntheticsPostParameterResponse returns the union data inside the PackagePolicyResponse as a SyntheticsPostParameterResponse
func (t PackagePolicyResponse) AsSyntheticsPostParameterResponse() (SyntheticsPostParameterResponse, error) {
	var body SyntheticsPostParameterResponse
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromSyntheticsPostParameterResponse overwrites any union data inside the PackagePolicyResponse as the provided SyntheticsPostParameterResponse
func (t *PackagePolicyResponse) FromSyntheticsPostParameterResponse(v SyntheticsPostParameterResponse) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeSyntheticsPostParameterResponse performs a merge with any union data inside the PackagePolicyResponse, using the provided SyntheticsPostParameterResponse
func (t *PackagePolicyResponse) MergeSyntheticsPostParameterResponse(v SyntheticsPostParameterResponse) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t PackagePolicyResponse) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *PackagePolicyResponse) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}
...
func ParsePostParametersResponse(rsp *http.Response) (*PostParametersResponse, error) {
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest PackagePolicyResponse
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON200 = &dest
