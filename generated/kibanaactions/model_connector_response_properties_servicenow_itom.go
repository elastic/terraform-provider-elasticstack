...
// checks if the ConnectorResponsePropertiesServicenowItom type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorResponsePropertiesServicenowItom{}

// ConnectorResponsePropertiesServicenowItom struct for ConnectorResponsePropertiesServicenowItom
...
func NewConnectorResponsePropertiesServicenowItom(config ConfigPropertiesServicenowItom, connectorTypeId string, id string, isDeprecated bool, isPreconfigured bool, name string) *ConnectorResponsePropertiesServicenowItom {
	this := ConnectorResponsePropertiesServicenowItom{}
	this.Config = config
...
func (o ConnectorResponsePropertiesServicenowItom) MarshalJSON() ([]byte, error) {
...
func (o ConnectorResponsePropertiesServicenowItom) ToMap() (map[string]interface{}, error) {
...
type NullableConnectorResponsePropertiesServicenowItom struct {
	value *ConnectorResponsePropertiesServicenowItom
	isSet bool
}

func (v NullableConnectorResponsePropertiesServicenowItom) Get() *ConnectorResponsePropertiesServicenowItom {
	return v.value
}

func (v *NullableConnectorResponsePropertiesServicenowItom) Set(val *ConnectorResponsePropertiesServicenowItom) {
	v.value = val
	v.isSet = true
}

func (v NullableConnectorResponsePropertiesServicenowItom) IsSet() bool {
	return v.isSet
}

func (v *NullableConnectorResponsePropertiesServicenowItom) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConnectorResponsePropertiesServicenowItom(val *ConnectorResponsePropertiesServicenowItom) *NullableConnectorResponsePropertiesServicenowItom {
	return &NullableConnectorResponsePropertiesServicenowItom{value: val, isSet: true}
}

func (v NullableConnectorResponsePropertiesServicenowItom) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConnectorResponsePropertiesServicenowItom) UnmarshalJSON(src []byte) error {
	v.isSet = true
