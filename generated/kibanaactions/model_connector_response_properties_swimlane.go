...
// checks if the ConnectorResponsePropertiesSwimlane type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorResponsePropertiesSwimlane{}

// ConnectorResponsePropertiesSwimlane struct for ConnectorResponsePropertiesSwimlane
...
func NewConnectorResponsePropertiesSwimlane(config ConfigPropertiesSwimlane, connectorTypeId string, id string, isDeprecated bool, isPreconfigured bool, name string) *ConnectorResponsePropertiesSwimlane {
	this := ConnectorResponsePropertiesSwimlane{}
	this.Config = config
...
func (o ConnectorResponsePropertiesSwimlane) MarshalJSON() ([]byte, error) {
...
func (o ConnectorResponsePropertiesSwimlane) ToMap() (map[string]interface{}, error) {
...
type NullableConnectorResponsePropertiesSwimlane struct {
	value *ConnectorResponsePropertiesSwimlane
	isSet bool
}

func (v NullableConnectorResponsePropertiesSwimlane) Get() *ConnectorResponsePropertiesSwimlane {
	return v.value
}

func (v *NullableConnectorResponsePropertiesSwimlane) Set(val *ConnectorResponsePropertiesSwimlane) {
	v.value = val
	v.isSet = true
}

func (v NullableConnectorResponsePropertiesSwimlane) IsSet() bool {
	return v.isSet
}

func (v *NullableConnectorResponsePropertiesSwimlane) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConnectorResponsePropertiesSwimlane(val *ConnectorResponsePropertiesSwimlane) *NullableConnectorResponsePropertiesSwimlane {
	return &NullableConnectorResponsePropertiesSwimlane{value: val, isSet: true}
}

func (v NullableConnectorResponsePropertiesSwimlane) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConnectorResponsePropertiesSwimlane) UnmarshalJSON(src []byte) error {
	v.isSet = true
