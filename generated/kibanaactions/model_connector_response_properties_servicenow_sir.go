...
// checks if the ConnectorResponsePropertiesServicenowSir type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorResponsePropertiesServicenowSir{}

// ConnectorResponsePropertiesServicenowSir struct for ConnectorResponsePropertiesServicenowSir
...
func NewConnectorResponsePropertiesServicenowSir(config ConfigPropertiesServicenow, connectorTypeId string, id string, isDeprecated bool, isPreconfigured bool, name string) *ConnectorResponsePropertiesServicenowSir {
	this := ConnectorResponsePropertiesServicenowSir{}
	this.Config = config
...
func (o ConnectorResponsePropertiesServicenowSir) MarshalJSON() ([]byte, error) {
...
func (o ConnectorResponsePropertiesServicenowSir) ToMap() (map[string]interface{}, error) {
...
type NullableConnectorResponsePropertiesServicenowSir struct {
	value *ConnectorResponsePropertiesServicenowSir
	isSet bool
}

func (v NullableConnectorResponsePropertiesServicenowSir) Get() *ConnectorResponsePropertiesServicenowSir {
	return v.value
}

func (v *NullableConnectorResponsePropertiesServicenowSir) Set(val *ConnectorResponsePropertiesServicenowSir) {
	v.value = val
	v.isSet = true
}

func (v NullableConnectorResponsePropertiesServicenowSir) IsSet() bool {
	return v.isSet
}

func (v *NullableConnectorResponsePropertiesServicenowSir) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConnectorResponsePropertiesServicenowSir(val *ConnectorResponsePropertiesServicenowSir) *NullableConnectorResponsePropertiesServicenowSir {
	return &NullableConnectorResponsePropertiesServicenowSir{value: val, isSet: true}
}

func (v NullableConnectorResponsePropertiesServicenowSir) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConnectorResponsePropertiesServicenowSir) UnmarshalJSON(src []byte) error {
	v.isSet = true
