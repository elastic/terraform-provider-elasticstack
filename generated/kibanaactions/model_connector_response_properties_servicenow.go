...
// checks if the ConnectorResponsePropertiesServicenow type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorResponsePropertiesServicenow{}

// ConnectorResponsePropertiesServicenow struct for ConnectorResponsePropertiesServicenow
...
func NewConnectorResponsePropertiesServicenow(config ConfigPropertiesServicenow, connectorTypeId string, id string, isDeprecated bool, isPreconfigured bool, name string) *ConnectorResponsePropertiesServicenow {
	this := ConnectorResponsePropertiesServicenow{}
	this.Config = config
...
func (o ConnectorResponsePropertiesServicenow) MarshalJSON() ([]byte, error) {
...
func (o ConnectorResponsePropertiesServicenow) ToMap() (map[string]interface{}, error) {
...
type NullableConnectorResponsePropertiesServicenow struct {
	value *ConnectorResponsePropertiesServicenow
	isSet bool
}

func (v NullableConnectorResponsePropertiesServicenow) Get() *ConnectorResponsePropertiesServicenow {
	return v.value
}

func (v *NullableConnectorResponsePropertiesServicenow) Set(val *ConnectorResponsePropertiesServicenow) {
	v.value = val
	v.isSet = true
}

func (v NullableConnectorResponsePropertiesServicenow) IsSet() bool {
	return v.isSet
}

func (v *NullableConnectorResponsePropertiesServicenow) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConnectorResponsePropertiesServicenow(val *ConnectorResponsePropertiesServicenow) *NullableConnectorResponsePropertiesServicenow {
	return &NullableConnectorResponsePropertiesServicenow{value: val, isSet: true}
}

func (v NullableConnectorResponsePropertiesServicenow) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConnectorResponsePropertiesServicenow) UnmarshalJSON(src []byte) error {
	v.isSet = true
