...
// checks if the ConnectorResponsePropertiesWebhook type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorResponsePropertiesWebhook{}

// ConnectorResponsePropertiesWebhook struct for ConnectorResponsePropertiesWebhook
...
func NewConnectorResponsePropertiesWebhook(config map[string]interface{}, connectorTypeId string, id string, isDeprecated bool, isPreconfigured bool, name string) *ConnectorResponsePropertiesWebhook {
	this := ConnectorResponsePropertiesWebhook{}
	this.Config = config
...
func (o ConnectorResponsePropertiesWebhook) MarshalJSON() ([]byte, error) {
...
func (o ConnectorResponsePropertiesWebhook) ToMap() (map[string]interface{}, error) {
...
type NullableConnectorResponsePropertiesWebhook struct {
	value *ConnectorResponsePropertiesWebhook
	isSet bool
}

func (v NullableConnectorResponsePropertiesWebhook) Get() *ConnectorResponsePropertiesWebhook {
	return v.value
}

func (v *NullableConnectorResponsePropertiesWebhook) Set(val *ConnectorResponsePropertiesWebhook) {
	v.value = val
	v.isSet = true
}

func (v NullableConnectorResponsePropertiesWebhook) IsSet() bool {
	return v.isSet
}

func (v *NullableConnectorResponsePropertiesWebhook) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConnectorResponsePropertiesWebhook(val *ConnectorResponsePropertiesWebhook) *NullableConnectorResponsePropertiesWebhook {
	return &NullableConnectorResponsePropertiesWebhook{value: val, isSet: true}
}

func (v NullableConnectorResponsePropertiesWebhook) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConnectorResponsePropertiesWebhook) UnmarshalJSON(src []byte) error {
	v.isSet = true
