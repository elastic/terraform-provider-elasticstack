...
// checks if the CreateConnectorRequestXmatters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateConnectorRequestXmatters{}
...
func NewCreateConnectorRequestXmatters(config map[string]interface{}, connectorTypeId string, name string, secrets map[string]interface{}) *CreateConnectorRequestXmatters {
	this := CreateConnectorRequestXmatters{}
	this.Config = config
...
func (o CreateConnectorRequestXmatters) MarshalJSON() ([]byte, error) {
...
func (o CreateConnectorRequestXmatters) ToMap() (map[string]interface{}, error) {
...
type NullableCreateConnectorRequestXmatters struct {
	value *CreateConnectorRequestXmatters
	isSet bool
}

func (v NullableCreateConnectorRequestXmatters) Get() *CreateConnectorRequestXmatters {
	return v.value
}

func (v *NullableCreateConnectorRequestXmatters) Set(val *CreateConnectorRequestXmatters) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateConnectorRequestXmatters) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateConnectorRequestXmatters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateConnectorRequestXmatters(val *CreateConnectorRequestXmatters) *NullableCreateConnectorRequestXmatters {
	return &NullableCreateConnectorRequestXmatters{value: val, isSet: true}
}

func (v NullableCreateConnectorRequestXmatters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateConnectorRequestXmatters) UnmarshalJSON(src []byte) error {
	v.isSet = true
