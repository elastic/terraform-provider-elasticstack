...
// checks if the ConnectorResponsePropertiesEmail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorResponsePropertiesEmail{}

// ConnectorResponsePropertiesEmail struct for ConnectorResponsePropertiesEmail
...
func NewConnectorResponsePropertiesEmail(config map[string]interface{}, connectorTypeId string, id string, isDeprecated bool, isPreconfigured bool, name string) *ConnectorResponsePropertiesEmail {
	this := ConnectorResponsePropertiesEmail{}
	this.Config = config
...
func (o ConnectorResponsePropertiesEmail) MarshalJSON() ([]byte, error) {
...
func (o ConnectorResponsePropertiesEmail) ToMap() (map[string]interface{}, error) {
...
type NullableConnectorResponsePropertiesEmail struct {
	value *ConnectorResponsePropertiesEmail
	isSet bool
}

func (v NullableConnectorResponsePropertiesEmail) Get() *ConnectorResponsePropertiesEmail {
	return v.value
}

func (v *NullableConnectorResponsePropertiesEmail) Set(val *ConnectorResponsePropertiesEmail) {
	v.value = val
	v.isSet = true
}

func (v NullableConnectorResponsePropertiesEmail) IsSet() bool {
	return v.isSet
}

func (v *NullableConnectorResponsePropertiesEmail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConnectorResponsePropertiesEmail(val *ConnectorResponsePropertiesEmail) *NullableConnectorResponsePropertiesEmail {
	return &NullableConnectorResponsePropertiesEmail{value: val, isSet: true}
}

func (v NullableConnectorResponsePropertiesEmail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConnectorResponsePropertiesEmail) UnmarshalJSON(src []byte) error {
	v.isSet = true
