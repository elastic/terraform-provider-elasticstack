...
// checks if the ConnectorResponsePropertiesServerlog type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorResponsePropertiesServerlog{}
...
func NewConnectorResponsePropertiesServerlog(config map[string]interface{}, connectorTypeId string, id string, isDeprecated bool, isPreconfigured bool, name string) *ConnectorResponsePropertiesServerlog {
	this := ConnectorResponsePropertiesServerlog{}
	this.Config = config
...
func (o ConnectorResponsePropertiesServerlog) MarshalJSON() ([]byte, error) {
...
func (o ConnectorResponsePropertiesServerlog) ToMap() (map[string]interface{}, error) {
...
type NullableConnectorResponsePropertiesServerlog struct {
	value *ConnectorResponsePropertiesServerlog
	isSet bool
}

func (v NullableConnectorResponsePropertiesServerlog) Get() *ConnectorResponsePropertiesServerlog {
	return v.value
}

func (v *NullableConnectorResponsePropertiesServerlog) Set(val *ConnectorResponsePropertiesServerlog) {
	v.value = val
	v.isSet = true
}

func (v NullableConnectorResponsePropertiesServerlog) IsSet() bool {
	return v.isSet
}

func (v *NullableConnectorResponsePropertiesServerlog) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConnectorResponsePropertiesServerlog(val *ConnectorResponsePropertiesServerlog) *NullableConnectorResponsePropertiesServerlog {
	return &NullableConnectorResponsePropertiesServerlog{value: val, isSet: true}
}

func (v NullableConnectorResponsePropertiesServerlog) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConnectorResponsePropertiesServerlog) UnmarshalJSON(src []byte) error {
	v.isSet = true
