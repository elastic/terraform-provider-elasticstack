...
import (
	...
	"github.com/elastic/terraform-provider-elasticstack/internal/kibana/exception_container"
	"github.com/elastic/terraform-provider-elasticstack/internal/kibana/exception_item"
...
func (p *Provider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		exception_container.NewExceptionContainerResource,
